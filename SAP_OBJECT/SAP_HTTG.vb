        ...
        Try
            ...
            Try
                If p_Table.Rows.Count > 0 Then
                    ...
                    'p_DataRowArr = p_Table.Select("ParName='E_DO_PROCESS'")
                    'If p_DataRowArr.Length > 0 Then
                    '    p_DO_Process = p_DataRowArr(0).Item("ParValue").ToString.Trim
                    'End If
                End If
            Catch ex As Exception
            ...
            If Check_SoLenh(l_err, l_solenh) = False Then   'Chua ton tai so lenh
                If NgayHetHieuLuc <> CDate("01/01/1900") Then
                    p_SQL = "INSERT INTO [tblLenhXuatE5] (DO_Process, NhomBeXuat,so_tktx, NOTE_SMO, SO_CHUYEN, LOAI_KH, BatchNum, DO1_MaNguon,CreateDate, PriceGroupDO1, SOType, PrcingDate, Inco1, Ngay_TKTX , DO1_SoLenh, DO1_MaKhach,STO, DiemTraHang, NgayHetHieuLuc, Slog, Client, SoLenhSAP,[MaLenh],[NgayXuat],[SoLenh],[MaDonVi],[MaNguon],[MaKho]," &
                    ...
                    p_SQL = p_SQL & " VALUES ('" & p_DO_Process & "', '" & g_NhomBeXuat & "','" & p_SoTKTX & "',N'" & p_NOTE_SMO & "', '" & p_SO_CHUYEN & "', '" & p_LOAI_KH & "', '" & p_Batch_ND & "', '" & p_MaNguonDo1 & "'," & p_CreateDate & ",'" & p_KONDA & "','" & p_SOType & "'," & IIf(p_PRSDT <> "", "'" & p_PRSDT & "'", "NULL") & ", '" & p_INCO1 & _
