Public Class U_CheckBox
    ...
    Private p_CheckValue As String = ""
    Private p_UnCheckValue As String = ""
    ...
    Public Property UnCheckValue() As String
        Get
            Return "N"
        End Get
        Set(ByVal value As String)
            p_UnCheckValue = value
        End Set
    ...
    '    Me.ToolTip = "NAME(" & Me.Name & ") VIEW(" & p_View_Name & ") TAB(" & p_Table_Name & ") FIELD (" & p_Field_Name & ") VALUE(" & Me.EditValue & ")"
    ...
    'Private Sub p_CheckedChanged(ByVal sender As Object, _
    '             ByVal e As System.Object) Handles MyClass.CheckedChanged
