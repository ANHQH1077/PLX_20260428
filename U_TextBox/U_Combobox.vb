Public Class U_Combobox
    ...
    Private p_DropDownRow As Integer = 10
    Private p_ShowHeader As Boolean = False
    ...
    Public Property DropDownRow() As Integer
        Get
            Return p_DropDownRow
        End Get
   ...
   Protected Overrides Sub OnHandleCreated(e As System.EventArgs)
        Me.Properties.ShowHeader = p_ShowHeader
