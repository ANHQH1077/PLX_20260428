Public Class U_ButtonCus
    ...
    'Private p_EnableFormLock As Boolean = False

    'Public Property EnableFormLock() As Boolean
    '    Get
    '        Return p_DefaultUpdate
    '    End Get
    '    Set(ByVal value As Boolean)
    ...
    Private p_EnableWhenFormLock As Boolean = False

    Public Property EnableWhenFormLock() As Boolean
        Get
            Return p_EnableWhenFormLock
        End Get
        Set(ByVal value As Boolean)
            p_EnableWhenFormLock = value
        End Set
    ...
    Public Sub ButtonClick()
        ...
        If UCase(Me.Name) = UCase(p_ButtonSave) Then
            ...
            End If
            p_Form.UpdateToDatabase(p_Form, p_ButtonSave)
    ...
    Private Sub p_UpdateToDatabaseNew(ByVal p_Form As Object)
        ...
        p_DataTable = p_Form.p_XtraModuleObj.p_ModCompileControlHeaderToSQL(p_Form.p_XtraDataSet_TrueGird, True, p_Form,
                                                                                    p_Form.HeaderSource, p_ItemKey, p_Form.SequenceName,
                                                                                    Nothing, p_Form.SequenceName, p_Form.p_XtraUserName)
