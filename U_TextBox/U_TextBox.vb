...
Public Class U_TextBox
    ...
    Private p_AutoKeyName As String = ""
    Private p_AutoKeyFix As String = ""

    Public Property AutoKeyFix() As String
        Get
            Return p_AutoKeyFix
        End Get
        Set(ByVal value As String)
    ...
    Public Property AutoKeyName() As String
        Get
            Return p_AutoKeyName
        End Get
        Set(ByVal value As String)
            p_AutoKeyName = value
        End Set
    ...
    Private Sub p_MouseMove(ByVal sender As Object, _
        ...
        'p_Form = FindForm()
        Try
            '  If Me.Properties.PasswordChar.ToString = "" Then
            Me.ToolTip = Me.Text
            ' End If
    ...
    Private Sub SubValueChanging(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ChangingEventArgs) Handles MyClass.EditValueChanging
        Dim p_Form As Object
        Try
            'If Me.FieldName.ToString.Trim = "" Then Exit Sub
            p_Form = FindForm()
    ...
    'Private Sub p_Validated1(ByVal sender As Object, _
    '         ByVal e As System.Object) Handles MyClass.
    ...
    Private Sub U_TextBox_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.Validating
        Dim p_Form As Object
        If Me.UpperValue = True Then
            ...
            If Not Me.EditValue Is Nothing Then
                If Me.EditValue.ToString.Trim <> "" Then
                    Me.EditValue = UCase(Me.EditValue.ToString.Trim)
                End If
            End If
        End If
    End Sub
