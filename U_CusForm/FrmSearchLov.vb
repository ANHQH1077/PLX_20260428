...
Public Class FrmSearchLov
    ...
    Private Sub HideColumn()
        ...
        p_CFLColumnHide = Replace(p_CFLColumnHide, " ", "", 1)
        For p_Count = 0 To Me.GridView1.Columns.Count - 1
            p_ColumnName = "," & UCase(Me.GridView1.Columns.Item(p_Count).ToString.Trim) & ","
            If InStr("," & UCase(p_CFLColumnHide) & ",", p_ColumnName, CompareMethod.Text) > 0 Then
...
#End Region
    ...
    Sub p_ChooseDoubleClick()
        ...
        If GridView1.FocusedRowHandle >= 0 Then
            If InStr(UCase(Fpt_Object.ToString), "VIEWS.GRID", CompareMethod.Text) > 0 Or InStr(UCase(Fpt_Object.ToString), "GRIDVIEW", CompareMethod.Text) > 0 Then   'Return cho Grid
