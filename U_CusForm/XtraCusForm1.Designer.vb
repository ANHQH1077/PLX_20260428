...
Partial Class XtraCusForm1
    ...
    Private Sub InitializeComponent()
        ...
        Me.U_Focus.Properties.Appearance.Options.UseFont = True
    ...
    Private p_ControlResize As Boolean = False

    Public Property ControlResize() As Boolean  'True: Lock form 
        Get
            Return p_ControlResize
        End Get
        Set(ByVal value As Boolean)
            p_ControlResize = value
        End Set
    ...
    Private p_SetValueOnwerForm As Boolean = False  ' Dung khi show them form nua len form hien tai
    'True: giu nguyen cac gia tri cua Object;  FALSE: kho load form thi reset lai ve gia tri ban dau

    Public Property SetValueOnwerForm() As Boolean  'True: Lock form 
        Get
            Return p_SetValueOnwerForm
        End Get
        Set(ByVal value As Boolean)
            p_SetValueOnwerForm = value
        End Set
