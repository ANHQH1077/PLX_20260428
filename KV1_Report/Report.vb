...
Module Report
    ...
    Public Sub mdlRptTTLenhXuat(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        ...
        p_Report.PrintingSystem.SetCommandVisibility(PrintingSystemCommand.ExportCsv, CommandVisibility.None)
        p_Report.PrintingSystem.SetCommandVisibility(PrintingSystemCommand.ExportFile, CommandVisibility.None)
        p_Report.PrintingSystem.SetCommandVisibility(PrintingSystemCommand.ExportGraphic, CommandVisibility.None)
        p_Report.PrintingSystem.SetCommandVisibility(PrintingSystemCommand.ExportHtm, CommandVisibility.None)
        ...
        p_Report.PrintingSystem.SetCommandVisibility(PrintingSystemCommand.ExportXls, CommandVisibility.None)
    ...
    Public Sub mdlRptBM_KSTT(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
        ...
        ' Dim p_Left_Title As Integer
        Dim p_Top_Title As Integer
        Dim p_Report As New RptTaiTrong
        Dim p_Row As DataRow
        Dim StrParameter As String = ""
        Dim p_Object() As Object
        Dim dtTable As DataTable = p_datatable
        ...
        With p_Report
            ...
            p_SQL = "select getdate() as cDate"
            p_DataTable1 = GetDataTable(p_SQL, p_SQL)
            p_SQL = ""
            If Not p_DataTable1 Is Nothing Then
                If p_DataTable1.Rows.Count > 0 Then
                    p_SQL = CDate(p_DataTable1.Rows(0).Item(0)).ToString("dd/MM/yyyy HH:mm:ss")
                End If
            End If

            If p_SQL <> "" Then
                .XrLabel42.Text = p_SQL
            End If
        End With
    ...
    Public Sub mdlHuyLenhXuat(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
        ...
        Dim p_Left_Title As Integer
        Dim p_Top_Title As Integer
        Dim p_Report As New RptLenhHuy
        Dim p_Row As DataRow
        Dim StrParameter As String = ""
        Dim p_Object() As Object
        Dim dtTable As DataTable = p_datatable
        ...
        With p_Report
            ...
            '    Next
            'End If
            .Parameters.Item("NgayThang").Value = StrParameter
            .Parameters.Item("NgayThang").Visible = False
        End With
