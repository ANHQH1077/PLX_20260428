...
Module KV2
    ...
    Public Function mdlTichke_new_PrintTrans(ByVal i_Preview As Boolean, _
        ...
        Dim p_SQL As String = "select  KEYVALUE  from [dbo].[SYS_CONFIG] where KEYCODE='ADDRESS'"

        ' Dim p_Rpt As New KV1_TichKe

        Dim p_Rpt As New KV1_TichKeNew
        ...
        If Not p_Table Is Nothing Then
            If p_Table.Rows.Count > 0 Then
                p_Address = p_Table.Rows(0).Item("KEYVALUE").ToString.Trim
            End If
        End If
