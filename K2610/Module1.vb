...
Module Module1
    ...
    'Public _rptTicke_new As rptTicke_new
    'Public _rptTicke_thuy As rptTicke_Thuy
    'Public _rptDelivery As rptDeleveries
    'Public _rptBill As rptBill
    ...
    Public Sub GetATG(ByVal p_Date As Date, ByVal p_MaBe As String,
