...
Public Class Class1
    ...
    'End Function
    Public Sub clsGetATG(ByVal p_Date As Date, ByVal p_MaBe As String,
    ...
    Public Sub clsIn_HoaDon(ByVal p_Form As Object, ByVal W_SoLenh As String, _
        ...
        In_HoaDon(p_Form, W_SoLenh, _
                      DtTable, _
                        DtTable1, _
                        DtTable2, _
                        SubTable, _
                        W_ChietKhau, p_Checked)


    End Sub


    Public Sub clsIn_HoaDon_HangGiuHo(ByVal p_Form As Object, ByVal W_SoLenh As String, _
                      ByRef DtTable As DataTable, _
                        ByRef DtTable1 As DataTable, _
                        ByRef DtTable2 As DataTable,
                        ByRef SubTable As DataTable, _
                        ByVal W_ChietKhau As Long, ByVal p_Checked As Boolean)
        In_HoaDon_HangGiuHo(p_Form, W_SoLenh, _
                  DtTable, _
                    DtTable1, _
                    DtTable2,
                    SubTable, _
    ...
    Public Sub ClsHoaDonTaiXuat(ByVal p_Form As Object, ByVal W_SoLenh As String, _
                      ByRef DtTable As DataTable, _
                        ByRef DtTable1 As DataTable, _
                        ByRef DtTable2 As DataTable,
                        ByRef SubTable As DataTable, _
                        ByVal W_ChietKhau As Long, ByVal p_Checked As Boolean)
        HoaDonTaiXuat(p_Form, W_SoLenh, _
                       DtTable, _
                         DtTable1, _
                         DtTable2,
                         SubTable, _
    ...
    Public Sub ClsHoaDonTaiXuat_En(ByVal p_Form As Object, ByVal W_SoLenh As String, _
                      ByRef DtTable As DataTable, _
                        ByRef DtTable1 As DataTable, _
                        ByRef DtTable2 As DataTable,
                        ByRef SubTable As DataTable, _
                        ByVal W_ChietKhau As Long, ByVal p_Checked As Boolean)
        HoaDonTaiXuat_En(p_Form, W_SoLenh, _
                       DtTable, _
                         DtTable1, _
                         DtTable2,
                         SubTable, _
    ...
    Public Sub ClsHoaDonTaiXuat_VN(ByVal p_Form As Object, ByVal W_SoLenh As String, _
                      ByRef DtTable As DataTable, _
                        ByRef DtTable1 As DataTable, _
                        ByRef DtTable2 As DataTable,
                        ByRef SubTable As DataTable, _
                        ByVal W_ChietKhau As Long, ByVal p_Checked As Boolean)
        HoaDonTaiXuat_VN(p_Form, W_SoLenh, _
                       DtTable, _
                         DtTable1, _
                         DtTable2,
                         SubTable, _
    ...
    Public Sub clsHoaDonTaiXuat_VCNB(ByVal p_Form As Object, ByVal W_SoLenh As String, _
                     ByRef DtTable As DataTable, _
                       ByRef DtTable1 As DataTable, _
                       ByRef DtTable2 As DataTable,
                       ByRef SubTable As DataTable, _
                       ByVal W_ChietKhau As Long, ByVal p_Checked As Boolean)
        HoaDonTaiXuat_VCNB(p_Form, W_SoLenh, _
                       DtTable, _
                         DtTable1, _
                         DtTable2,
                         SubTable, _
    ...
    Public Sub clsHoaDon_VCNB_CIF(ByVal p_Form As Object, ByVal W_SoLenh As String, _
                     ByRef DtTable As DataTable, _
                       ByRef DtTable1 As DataTable, _
                       ByRef DtTable2 As DataTable,
                       ByRef SubTable As DataTable, _
                       ByVal W_ChietKhau As Long, ByVal p_Checked As Boolean)
        HoaDon_VCNB_CIF(p_Form, W_SoLenh, _
                       DtTable, _
                         DtTable1, _
                         DtTable2,
                         SubTable, _
    ...
    Public Sub clsHoaDon_VCNB_DCCH(ByVal p_Form As Object, ByVal W_SoLenh As String, _
                     ByRef DtTable As DataTable, _
                       ByRef DtTable1 As DataTable, _
                       ByRef DtTable2 As DataTable,
                       ByRef SubTable As DataTable, _
                       ByVal W_ChietKhau As Long, ByVal p_Checked As Boolean)
        HoaDon_VCNB_DCCH(p_Form, W_SoLenh, _
                       DtTable, _
                         DtTable1, _
                         DtTable2,
                         SubTable, _
    ...
    Public Sub clsHoaDon_VCNB_NBN(ByVal p_Form As Object, ByVal W_SoLenh As String, _
                        ByRef DtTable As DataTable, _
                          ByRef DtTable1 As DataTable, _
                          ByRef DtTable2 As DataTable,
                          ByRef SubTable As DataTable, _
                          ByVal W_ChietKhau As Long, ByVal p_Checked As Boolean)
        HoaDon_VCNB_NBN(p_Form, W_SoLenh, _
                       DtTable, _
                         DtTable1, _
                         DtTable2,
                         SubTable, _
    ...
    Public Sub New(ByVal p_Config_XMLDatatable As DataTable, ByVal p_Company_Code As String, ByVal p_WareHouse As String, ByVal p_Services As Object, ByVal p_UsrB1 As String, ByVal p_PassB1 As String, ByVal p_Port As String, _
        ...
        p_SQL = "SELECT  MaDonVi ,TenDonVi, ( select CompanyName from tblconfig ) as CompanyName FROM [tblDonvi] where MaDonVi='" & g_Company_Code & "'"
        g_TableDonvi = GetDataTable(p_SQL, p_SQL)
        If Not g_TableDonvi Is Nothing Then
            If g_TableDonvi.Rows.Count > 0 Then
                Try
                    g_TenDonVi = g_TableDonvi.Rows(0).Item("TenDonVi").ToString.Trim
                    g_TenDonVi = g_TableDonvi.Rows(0).Item("CompanyName").ToString.Trim
                Catch ex As Exception
                    g_TenDonVi = g_TableDonvi.Rows(0).Item("TenDonVi").ToString.Trim
                End Try
