...
Module KV2
    ...
    Public Function mdlTichke_PrintTrans_new(ByVal i_Preview As Boolean, ByVal i_dt_trans As DataTable, _
        ...
        Try
            ...
            '   In Ticke
            '-------------------------------------------------------------------------            
            If g_WareHouse = "2011" Then
                If Not mdlTichke_new_PrintTrans_PhuDuc(i_Preview, l_header, i_dt_trans, i_dt_sub, o_err) Then
                    ' o_err = "m021"
                    Return False
                End If
                'Exit Function
    ...
    Public Function mdlTichke_new_PrintTrans(ByVal i_Preview As Boolean, _
        ...
        If Not p_DataTable Is Nothing Then
            If p_DataTable.Rows.Count > 0 Then
                p_TIme = CDate(p_DataTable.Rows(0).Item(0)).ToString("dd/MM/yyyy HH:mm:ss")
            End If
        End If
        ...
        Try
            ...
            Try
                p_Rpt.XrLabel35.Text = "Ngày giờ in: " & p_TIme
            Catch ex As Exception

            End Try
            Try
                p_Rpt_A3.XrLabel35.Text = "Ngày giờ in: " & p_TIme
            Catch ex As Exception
    ...
    Public Function mdlTichke_new_PrintTrans_PhuDuc(ByVal i_Preview As Boolean, _
                                        ByVal i_header() As String, _
                                        ByVal i_dt_trans As DataTable, _
                                        ByVal i_dt_sub As DataTable, ByRef p_Err As String) As Boolean
        Dim p_Rpt As New KV2_TichKe_New
