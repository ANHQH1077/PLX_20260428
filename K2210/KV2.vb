...
Module KV2
    ...
    Public Function mdlTichke_new_PrintTrans(ByVal i_Preview As Boolean, _
        ...
        Dim p_Rpt_A3 As New KV2_TichKe_A3
        ...
        Try
            ...
            If Not i_dt_trans Is Nothing Then
                If i_dt_trans.Rows.Count > 0 Then
                    p_BarCode = i_dt_trans.Rows(0).Item("MaTichKe").ToString & ":" & _
                            CDate(i_dt_trans.Rows(0).Item("NgayXuat")).ToString("yyyy") & _
                             CDate(i_dt_trans.Rows(0).Item("NgayXuat")).ToString("MM") & _
                              CDate(i_dt_trans.Rows(0).Item("NgayXuat")).ToString("dd")
                End If
            End If
            ...
            If p_BarCode <> "" Then
                p_Rpt.XrBarCode1.Text = p_BarCode
                p_Rpt_A3.XrBarCode1.Text = p_BarCode
            End If
