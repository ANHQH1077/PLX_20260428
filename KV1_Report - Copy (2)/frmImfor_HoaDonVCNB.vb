Public Class frmImfor_HoaDonVCNB
    ...
    Private Sub frmImfor_HoaDonVCNB_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        txtDonViGiaoHang.Text = Provider.Rows(0).Item(2).ToString() 'txtDonViGiaoHang.Text = Provider.Rows(0).Item(0).ToString()
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        ...
        Dim p_RpHoaDonVCNB As New KV1_HoaDonVCNB
        Dim p_RpHoaDonVCNB_Sub As New KV1_HoaDonVCNB_Sub
        ...
        Try
            ...
            p_RpHoaDonVCNB.Parameters.Item("PNgayDieuDong1").Value = srt_dieudong.Substring(0, 2)
            p_RpHoaDonVCNB.Parameters.Item("PThangDieuDong1").Value = srt_dieudong.Substring(3, 2)
            p_RpHoaDonVCNB.Parameters.Item("PNamDieuDong1").Value = srt_dieudong.Substring(6, 4)

            'rpt.SetParameterValue("P_Nam", srt_dt.Substring(8, 2))

            p_RpHoaDonVCNB.Parameters.Item("P_SoLenh").Value = txtSoLenh.Text.Trim()
            p_RpHoaDonVCNB.Parameters.Item("PCuaDonVi1").Value = txtCompany.Text
            ...
            p_RpHoaDonVCNB.Parameters.Item("P_DonViCungCapVanTai").Value = txtDonViCungCapVanTai.Text
        ...
        Try
            ...
            For index As Integer = 0 To Me.GridView1.RowCount - 1
                ...
                p_SQL = "exec ThongTinHoaDonTransaction " & _
                    ...
                    ",'" & CDate(dtNgayXuat.EditValue).ToString("yyyyMMdd") & "'" & _
                    ",0" & _
                    ",0" & _
                    ",0" & _
                        ",''" & _
    ...
    Private Function ND_VCF(ByVal LTT As String, ByVal productID As String, ByVal unitID As String, ByVal dgvRow As Integer) As String
        ...
        Try
            ...
            '   ND = Format(CDbl(ND), "n2").ToString 'hieptd4 add
            If ND.Contains(".") Then
                ND = ND.Replace(".", ",")
            End If
