    ...
    Public Sub GET_HTTG_GET_LX_STAGING_AUTO()
        ...
        Try
            ...
            If Not p_SoLenhTbl Is Nothing Then
                'LogWrite("Done11:" & p_SoLenhTbl.Rows.Count)
...
TaoMaLenh:
    ...
    Public Sub LogWrite(ByVal p_Desc As String)

        Dim filePath As String = Application.StartupPath & "\Log_" & Now().ToString("yyyyMMdd") & ".txt"

        If Not System.IO.File.Exists(filePath) Then
            System.IO.File.Create(filePath).Dispose()
        End If

        Using writer As New StreamWriter(filePath, True) ' True for append, False for overwrite
            writer.WriteLine(Now.ToString & "   " & p_Desc)
        End Using ' The Using block automatically closes and disposes the StreamWriter
    End Sub
