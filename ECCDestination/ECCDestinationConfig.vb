...
Public Class ECCDestinationConfig
    ...
    Public Function clsGetDensity(ByVal p_date As String, ByRef p_TableLine As DataTable, ByRef o_err As String, _
                                    ByVal p_WareHouse As String, Optional ByVal p_TankCode As String = "", Optional ByVal p_MaHangHoa As String = "") As Boolean
        clsGetDensity = GetDensity(p_date, p_TableLine, o_err, p_WareHouse, p_TankCode, p_MaHangHoa)
    End Function
    ...
    Public Sub New(ByVal pv_ConnectString As String, ByVal pv_Language As String, ByVal pv_IdleTimeout As String, ByVal p_CompanyCode As String, _
        ...
        If pv_ClientApp <> "" Then
            g_ClientApp = pv_ClientApp
        End If
        If pv_UserNameApp <> "" Then
    ...
    Public Function clsGet_SO_PO_Type_Infor(ByRef o_err As String) As DataTable
        clsGet_SO_PO_Type_Infor = Get_SO_PO_Type_Infor(o_err)
    ...
    'Public Sub clsGET_HTTG_GET_LX_STAGING(ByVal p_SoLenh As String,
    '                                          ByRef T_DETAIL As IRfcTable, ByRef T_DELIVERIES As IRfcTable, ByRef T_DELIVERIES_CP As IRfcTable,
    '                                          ByRef T_HEADER As IRfcTable, ByRef T_HEADER_THN2 As IRfcTable, ByRef T_DETAIL_THN2 As IRfcTable,
    '                                          ByRef T_HEADER_THN3 As IRfcTable, ByRef T_DETAIL_THN3 As IRfcTable, ByVal T_ROUTE As IRfcTable,
    '                                          ByRef o_err As String)
    '    GET_HTTG_GET_LX_STAGING(p_SoLenh, T_DETAIL, T_DELIVERIES, T_DELIVERIES_CP,
    '                                       T_HEADER, T_HEADER_THN2, T_DETAIL_THN2,
    '                                       T_HEADER_THN3, T_DETAIL_THN3, T_ROUTE, o_err)
    'End Sub

    Public Function clsGET_HTTG_GET_LX_STAGING(ByVal p_SoLenh As String,
                                              ByRef o_err As String) As System.Data.DataTable
        clsGET_HTTG_GET_LX_STAGING = GET_HTTG_GET_LX_STAGING(p_SoLenh, o_err)
    End Function
End Class