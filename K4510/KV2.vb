...
Module KV2
    ...
    Public Function mdlTichke_PrintTrans_new(ByVal i_Preview As Boolean, ByVal i_dt_trans As DataTable, _
        ...
        Try
            ...
            Dim p_SQL As String = ""
            Dim p_Datatable As DataTable
            p_SQL = "select KeyValue from sys_config  where upper(KeyCode) = 'TICHKEA5'"
            ...
            If Not p_Datatable Is Nothing Then
                ...
                End If
            End If
            If p_MauA5 = False Then
                If Not mdlTichke_new_PrintTrans(i_Preview, l_header, i_dt_trans, i_dt_sub, o_err) Then
                    ' o_err = "m021"
                    Return False
                End If
            Else
                If Not mdlTichke_new_PrintTrans_A5(i_Preview, l_header, i_dt_trans, i_dt_sub, o_err) Then
                    ' o_err = "m021"
                    Return False
                End If
            End If
    ...
    Public Function mdlTichke_new_PrintTrans_A5(ByVal i_Preview As Boolean, _
                                        ByVal i_header() As String, _
                                        ByVal i_dt_trans As DataTable, _
                                        ByVal i_dt_sub As DataTable, ByRef p_Err As String) As Boolean
        Dim p_Rpt As New KV2_TichKe_A5
        Dim p_RptThuy As New KV2_TichKe_Thuy
        Try
            '    Me.p_Day = RpDataset1.Tables("wwTrans").Rows(0).Item("NgayXuat")
            '    Me.p_Month = RpDataset1.Tables("wwTrans").Rows(0).Item("NgayXuat")
