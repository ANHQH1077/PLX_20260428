Module Module2
    ...
    Public Function ND_VCF_New(GridView1 As U_TextBox.GridView, ByVal LTT As String, ByVal productID As String, ByVal unitID As String, ByVal dgvRow As Integer, Optional p_MaVanChuyen As String = "ZT") As String
