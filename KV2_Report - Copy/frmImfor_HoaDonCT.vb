Public Class frmImfor_HoaDonCT
    ...
    Private Sub frmImfor_HoaDon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            'anhqh
            '20180514
            'Với hóa đơn chuyển thẳng thì các thông tin về đơn vị bán hàng se lấy theo khách hàng
            'còn các thông tin về khách hàng sẽ để trống để user nhập
            ...
            txtDonViBanHang.Text = Provider.Tables(0).Rows(0).Item(4).ToString()
            txtDiaChiDonViBanHang.Text = Provider.Tables(0).Rows(0).Item(5).ToString()
            txtMaSoThueDonViBanHang.Text = Provider.Tables(0).Rows(0).Item(6).ToString()
            ...
            txtThueGTGT.EditValue = Provider.Tables(0).Rows(0).Item("Tax").ToString  'hieptd4 add 20161102
            txtPhuongThuc.Text = Provider.Tables(0).Rows(0).Item("PhuongThucThanhToan").ToString 'hieptd4 add 20161102
            txtThoiHanThanhToan.Text = Provider.Tables(0).Rows(0).Item("ThoiHanThanhToan").ToString 'hieptd4 add 20161102
            txtDonViCCVanTai.Text = Provider.Tables(0).Rows(0).Item("DonViCungCapVanTai").ToString 'hieptd4 add 20161102
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        ...
        Dim p_SQL As String
        Dim p_RptHoasDon1 As New KV2_HoaDonct
        Dim p_RptHoasDon_Sub1 As New KV2_HoaDonCT_Sub
        Dim p_RptHoasDon As New KV2_HoaDonct  'KV2_HoaDonVCNB
        Dim p_RptHoasDon_Sub As New KV2_HoaDonCT_Sub  'KV2_HoaDonVCNB_Sub
        Dim p_Count As Integer
        ...
        Try
            ...
            If W_ChietKhau > 0 Then
                ...
                p_RptHoasDon1.Parameters.Item("P_DiaChi_MH").Value = txtMaSoThue.Text.ToString.Trim   ' DtTable.Rows(0).Item("DiaChi").ToString
                ...
                'anhqh 20180526 sua theo yeu cau
                ...
                p_RptHoasDon1.Parameters.Item("P_MaKhachHang").Value = Mid(txtMaDonViMuaHang.Text, Len(txtMaDonViMuaHang.Text) - 5)
                'anhqh
                '20180525 sua theo yeu cau  TenKho99
                'p_RptHoasDon1.Parameters.Item("P_KhoXuat").Value = DtTable.Rows(0).Item("MaKho").ToString

                p_RptHoasDon1.Parameters.Item("P_KhoXuat").Value = DtTable.Rows(0).Item("TenKho99").ToString
                ...
                Dim times As Date = Get_ThoiGianDau(Me.TxtSoLenh.Text) ' Convert.ToDateTime(DtTable.Rows(0).Item("NgayXuat").ToString)
                p_RptHoasDon1.Parameters.Item("P_NgayGiaoDich").Value = String.Format("{0:dd/MM/yyyy}", times)
                p_RptHoasDon1.Parameters.Item("P_GioXuatHang").Value = Format(times, "HH:mm:ss") 'times.Hour.ToString + ":" + times.Minute.ToString + ":" + times.Second.ToString
            ...
            Else
                Try
                    ...
                    'If p_CIF = True Then
                    p_RptHoasDon.Parameters.Item("P_LenhXuat").Value = "(Theo lệnh xuất số " + Me.txtPXK.Text + " - " + srt_dt + " )"
                    'Else
                    ...
                    p_RptHoasDon.Parameters.Item("P_MaSoThue_MH").Value = txtMaSoThue.Text.ToString.Trim   ' DtTable.Rows(0).Item("MaSoThue").ToString
                    ...
                    p_RptHoasDon.Parameters.Item("P_MaKhachHang").Value = Mid(txtMaDonViMuaHang.Text, Len(txtMaDonViMuaHang.Text) - 5) ' txtMaDonViMuaHang.Text
                    ...
                    p_RptHoasDon.Parameters.Item("P_KhoXuat").Value = DtTable.Rows(0).Item("TenKho99").ToString
                    ...
                    Dim times As Date = Get_ThoiGianDau(Me.TxtSoLenh.Text)  ' p_Date   ' Convert.ToDateTime(DtTable.Rows(0).Item("NgayXuat").ToString)
                    p_RptHoasDon.Parameters.Item("P_NgayGiaoDich").Value = String.Format("{0:dd/MM/yyyy}", times)
                    p_RptHoasDon.Parameters.Item("P_GioXuatHang").Value = Format(times, "HH:mm:ss")   ' times.Hour.ToString + ":" + times.Minute.ToString + ":" + times.Second.ToString
