Module Report
    ...
    Private Sub mdlRPT0001_TH(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        ...
        Dim p_Report As New RPT0001_TH
            ...
            If Not p_DataTable1 Is Nothing Then
                ...
                If p_count1 > 0 Then
                    ...
                    For p_Count = 0 To p_count1 - 1
                        ...
                        p_Report.ReportFooter.Controls.Add(labelDetail)
            ...
            If p_Arr.Length > 0 Then
                For p_Count = 0 To p_Arr.Length - 1
                    ...
                    If StrParameter <> "" Then
                        labelDetail = New DevExpress.XtraReports.UI.XRLabel
                        labelDetail.WidthF = .lbTitle.WidthF
                        labelDetail.LeftF = .lbTitle.LeftF
                        labelDetail.Text = StrParameter
                        labelDetail.TopF = .lbTitle.TopF + .lbTitle.HeightF + 5
                        ...
                        .ReportHeader.HeightF = .ReportHeader.HeightF + labelDetail.HeightF
                    End If
                Next
            End If
        End With
    ...
    Private Sub mdlRPT0001(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
            ...
            If p_Arr.Length > 0 Then
                For p_Count = 0 To p_Arr.Length - 1
                    ...
                    If StrParameter <> "" Then
                        ...
                        labelDetail.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter
                        labelDetail.HeightF = labelDetail.HeightF + (labelDetail.HeightF * 0.5)
                        .ReportHeader1.Controls.Add(labelDetail)
    ...
    Private Sub mdlRPT0002(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
    ...
    Private Sub mdlRPT0002_TH(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
        ...
        Dim p_Left_Title As Integer
        Dim p_Top_Title As Integer
        Dim p_Report As New RPT0002_TH
        Dim p_Row As DataRow
        Dim StrParameter As String = ""
        Dim p_Object() As Object
    ...
    Private Sub mdlRPT0003(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
    ...
    Private Sub mdlRPT0003_TH(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
        ...
        Dim p_Left_Title As Integer
        Dim p_Top_Title As Integer
        Dim p_Report As New RPT0003_TH
        Dim p_Row As DataRow
        Dim StrParameter As String = ""
        Dim p_Object() As Object
    ...
    Private Sub mdlRPT0004(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
    ...
    Private Sub mdlRPT0005(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
    ...
    Private Sub mdlRPT0004_TH(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
        ...
        Dim p_Left_Title As Integer
        Dim p_Top_Title As Integer
        Dim p_Report As New RPT0004_TH
        Dim p_Row As DataRow
        Dim StrParameter As String = ""
        Dim p_Object() As Object
    ...
    Private Sub mdlRPT0005_TH(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
        ...
        Dim p_Left_Title As Integer
        Dim p_Top_Title As Integer
        Dim p_Report As New RPT0005_TH
        Dim p_Row As DataRow
        Dim StrParameter As String = ""
        Dim p_Object() As Object
    ...
    Public Sub InBaoCaoNew(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        ...
        Select Case p_ReportCode
            Case "RPT002"
                mdlRPT0001(p_Form, p_datatable, p_ReportCode)
            Case "RPT003"
                mdlRPT0002(p_Form, p_datatable, p_ReportCode)
            Case "RPT004"
                mdlRPT0003(p_Form, p_datatable, p_ReportCode)
            Case "RPT005"
                mdlRPT0004(p_Form, p_datatable, p_ReportCode)
            Case "RPT006"
                mdlRPT0005(p_Form, p_datatable, p_ReportCode)
            Case "RPT002_TH"
                mdlRPT0001_TH(p_Form, p_datatable, p_ReportCode)
            Case "RPT003_TH"
                mdlRPT0002_TH(p_Form, p_datatable, p_ReportCode)
            Case "RPT004_TH"
                mdlRPT0003_TH(p_Form, p_datatable, p_ReportCode)
            Case "RPT005_TH"
                mdlRPT0004_TH(p_Form, p_datatable, p_ReportCode)
            Case "RPT006_TH"
                mdlRPT0005_TH(p_Form, p_datatable, p_ReportCode)
            Case Else
