    ...
    Private Sub frmImfor_HoaDon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            For p_Count = 0 To GridView1.Columns.Count - 1
                ...
                If UCase(GridView1.Columns(p_Count).FieldName.ToString.Trim) = "ĐƠNGIÁ" Then
                    GridView1.Columns(p_Count).OptionsColumn.ReadOnly = False
                    GridView1.Columns(p_Count).DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                    GridView1.Columns(p_Count).DisplayFormat.FormatString = "#,###0."
                Else
