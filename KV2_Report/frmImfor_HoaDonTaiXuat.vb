Public Class frmImfor_HoaDonTaiXuat
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        ...
        Try
            ...
            rpt.Parameters.Item("P_NgayHopDong").Value = txtNgayHopDong.Text
            ...
            Dim times As Date = Get_ThoiGianDau(W_SoLenh) ' Convert.ToDateTime(DtTable.Rows(0).Item("NgayXuat").ToString)
