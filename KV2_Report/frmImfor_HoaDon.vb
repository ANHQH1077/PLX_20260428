Public Class frmImfor_HoaDon
    ...
    Private Sub frmImfor_HoaDon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            End If
            p_SQL = " Exec  [sp_Reports_TaoHoaDonDienTu]  '" & p_SoLenh & "', '" & g_UserName & "','" & p_KeyCode & "', 'GTGT'"
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim p_SQL As String
        Dim p_RptHoasDon1 As New KV2_HoaDon_New
        Dim p_RptHoasDon_Sub1 As New KV2_HoaDon_SubNew
        Dim p_RptHoasDon As New KV2_HoaDon_New  'KV2_HoaDonVCNB
        Dim p_RptHoasDon_Sub As New KV2_HoaDon_SubNew  'KV2_HoaDonVCNB_Sub
        Dim p_Count As Integer
        ...
        Try
            ...
            If W_ChietKhau > 0 Then
                ...
                'anhqh
                '20190808
                'truyen cho Subreport
                p_RptHoasDon_Sub1.Parameters.Item("P_TongCong").Value = Format(Convert.ToInt64(TongTien - W_ChietKhau), "n0").Replace(",", ".")
                ' 01/02/2013 QueHV Sua cach tinh thue GTGT theo cach tinh ma nghiep vu cung cap
                p_RptHoasDon_Sub1.Parameters.Item("P_ThueGTGT").Value = txtThueGTGT.Text.Trim
                p_RptHoasDon_Sub1.Parameters.Item("P_TienThueGTGT").Value = Format(CInt(W_ThueGTGT), "n0").Replace(",", ".")
                TongThanhToan = TongTien - W_ChietKhau + W_ThueGTGT
                p_RptHoasDon_Sub1.Parameters.Item("P_TongThanhToan").Value = Format(TongThanhToan, "n0").Replace(",", ".")
            ...
            Else
                Try
                    ...
                    If p_CIF = True Then
                        p_RptHoasDon.Parameters.Item("P_LenhXuat").Value = "( Theo PXK số " + Me.txtPXK.Text + " - " + srt_dt + " )"
                    Else
                    ...
                    p_RptHoasDon_Sub.Parameters.Item("P_TongCong").Value = Format(Convert.ToInt64(TongTien - W_ChietKhau), "n0").Replace(",", ".")

                    ' 01/02/2013 QueHV Sua cach tinh thue GTGT theo cach tinh ma nghiep vu cung cap
                    p_RptHoasDon_Sub.Parameters.Item("P_ThueGTGT").Value = txtThueGTGT.Text.Trim
                    p_RptHoasDon_Sub.Parameters.Item("P_TienThueGTGT").Value = Format(CInt(W_ThueGTGT), "n0").Replace(",", ".")

                    Dim TongThanhToan As Long = 0
                    TongThanhToan = TongTien - W_ChietKhau + W_ThueGTGT
                    'TongThanhToan = TongTien + TienPhiKhac + (TongTien * Convert.ToInt64(txtThueGTGT.Text.Trim) / 100)
                    p_RptHoasDon_Sub.Parameters.Item("P_TongThanhToan").Value = Format(TongThanhToan, "n0").Replace(",", ".")
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        ...
        'p_SQL = "TaoMaTraCuu '" & p_SoLenh & "','" & "'"
        'p_Table = GetDataTable(p_SQL, p_SQL)
        'If Not p_Table Is Nothing Then
        '    If p_Table.Rows.Count > 0 Then
        '        If p_Table.Rows(0).Item("ErrorNum") = 0 Then
        '            p_Matracuu = p_Table.Rows(0).Item("MaTraCuu")
        '        Else
        '            ShowMessageBox("", p_Table.Rows(0).Item("ErrorDesc"))
    ...
    Private Sub GridView1_ValidatingEditor(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.BaseContainerValidateEditorEventArgs) Handles GridView1.ValidatingEditor
        If UCase(Me.GridView1.FocusedColumn.FieldName.ToString.Trim) = UCase("DonGia") Then
            ...
            If Not p_Row Is Nothing Then
                ...
                p_ThanHTien = p_SoLuong * p_DonGia
