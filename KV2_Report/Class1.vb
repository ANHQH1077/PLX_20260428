...
Public Class Class1
    ...
    Public Sub InBaoCaoNew(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String, ByVal p_DataSetReturn As DataSet)

        Dim p_SQL As String = "select * from tblVCF"

        If g_tblVCF Is Nothing Then
        ...
        Select Case p_ReportCode
            ...
            Case "BM_01_14"
                mdlRptBM_01_14(p_Form, p_datatable, p_ReportCode)
            ...
            Case "BM_05_04_01"
                mdlRptBM_05_04_01(p_Form, p_datatable, p_ReportCode)

            Case "BM_06_01"
                mdlRptBM_06_01(p_Form, p_datatable, p_ReportCode)
            Case "BM_06_02"
                mdlRptBM_06_02(p_Form, p_datatable, p_ReportCode)
            Case "BM_06_03"
                mdlRptBM_06_03(p_Form, p_datatable, p_ReportCode)
            Case "BM_00_01"
                mdlRptBM_00_01(p_Form, p_datatable, p_ReportCode)
            Case "BM_01_14_BB"
                mdlRptBM_01_14_BienBan(p_datatable, p_ReportCode)
            Case "LK_BBBG"
                InLietKeBienBanGiaoNhan(p_Form, p_DataSetReturn, p_ReportCode)
            Case ("BM_05_04_HH")
                mdlRptBM_05_04_01_HH(p_Form, p_DataSetReturn, p_ReportCode)
    ...
    Public Sub clsInBaoCaoNew(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String,
        ...
        ByVal p_SYS_CONFIG_RPT As DataTable, _
            ByVal p_SYS_CONFIG_RPT_FIELD As DataTable, ByVal p_DataSetReturn As DataSet)
        ...
        InBaoCaoNew(p_Form, p_datatable, p_ReportCode, p_DataSetReturn)
    End Sub
    ...
    Public Sub New(ByVal p_Config_XMLDatatable As DataTable, ByVal p_Company_Code As String, ByVal p_WareHouse As String, ByVal p_Services As Object, ByVal p_UsrB1 As String, ByVal p_PassB1 As String, ByVal p_Port As String, _
        ...
        p_SQL = p_SQL & "select isnull(Excel_Rpt,'') as Excel_Rpt  from SYS_USER  where upper(USER_NAME ) = upper('" & p_UserName & "');"
    ...
    Public Sub InChungTuHoaDon_All(ByVal p_Form As Object, ByVal p_Type As String, ByVal p_SoLenh As String)
        Dim l_err As String
         Select p_Type
            Case "LENHXKTHEOPHOI"
                If Not Print_LenhXKTheoPhoi(True, p_SoLenh, l_err) Then
                    ShowMessageBox("", l_err)
                End If
            Case "LENHXUATKHOKDD"
                If Not Print_LENHXUATKHOKDD(True, p_SoLenh, l_err) Then
                    ShowMessageBox("", l_err)
                End If
            Case "LENHXUATKHOKDDA4"
                If Not Print_LENHXUATKHOKDDA4(True, p_SoLenh, l_err) Then
                    ShowMessageBox("", l_err)
                End If
        End Select
    End Sub
    ...
    Public Function Print_LenhXuatKho(ByVal i_preview As Boolean, ByVal i_SoLenh As String, ByRef o_err As String) As Boolean
        ...
        Try
            ...
            p_KV1_LenhxuatKho.Parameters.Item("SoTKHQNhap").Value = DtTable.Rows(0).Item("SoTKHQNhap").ToString()

            p_KV1_LenhxuatKho.Parameters.Item("SoTKHQNhap").Visible = False
            ...
            Try
                p_KV1_LenhxuatKho.Parameters.Item("p_NguoiLap").Value = DtTable.Rows(0).Item("CreateBy").ToString
                p_KV1_LenhxuatKho.Parameters.Item("p_NguoiLap").Visible = False
            Catch ex As Exception
    ...
    Public Function Print_LenhXKTheoPhoi(ByVal i_preview As Boolean, ByVal i_SoLenh As String, ByRef o_err As String) As Boolean
        ...
        Try
            ...
            Try
                p_KV1_LenhxuatKho.Parameters.Item("p_NguoiLap").Value = DtTable.Rows(0).Item("CreateBy").ToString
                'p_KV1_LenhxuatKho.Parameters.Item("p_NguoiLap").Visible = True
            Catch ex As Exception
    ...
    Public Function Print_LENHXUATKHOKDD(ByVal i_preview As Boolean, ByVal i_SoLenh As String, ByRef o_err As String) As Boolean
        ...
        Try
            ...
            'anhqh
            '20171102
            'sua theo yeu cau ToanNT11
            If DtTable.Rows(0).Item("MaPhuongThucBan").ToString.Trim = "03" Then
                p_KV1_LenhxuatKho.Parameters.Item("DonViCungCapVanTai").Value = DtTable.Rows(0).Item("DonViCungCapVanTai11")
            Else
                p_KV1_LenhxuatKho.Parameters.Item("DonViCungCapVanTai").Value = DtTable.Rows(0).Item("DonViCungCapVanTai")
            End If
            'p_KV1_LenhxuatKho.Parameters.Item("DonViCungCapVanTai").Value = DtTable.Rows(0).Item("DonViCungCapVanTai")    ' DtTable.Rows(0).Item("DonViCungCapVanTai")
            ...
            'Sua theo yeu cau ToanNT11
            'If DtTable.Rows(0).Item("MaPhuongThucBan").ToString.Trim = "03" Then
            '    If DtTable.Rows(0).Item("SoChuyenVanTai").ToString = "V144" Or DtTable.Rows(0).Item("SoChuyenVanTai").ToString = "" Then    'Khong TD
            '        p_KV1_LenhxuatKho.Parameters.Item("KhoNhap ").Value = ""   ' DtTable.Rows(0).Item("DVNhanHang").ToString
            '    Else
            '        'p_KV1_LenhxuatKho.Parameters.Item("SoChuyenVanTai").Value = DtTable.Rows(0).Item("SoChuyenVanTai").ToString
            '        '  If DtTable.Rows(0).Item("MaTuyenDuong").ToString.Trim = "6630CH" Then
            '        p_KV1_LenhxuatKho.Parameters.Item("KhoNhap").Value = DtTable.Rows(0).Item("DGDiemDen").ToString()
            '        '    Else
            '        '    p_KV1_LenhxuatKho.Parameters.Item("KhoNhap").Value = DtTable.Rows(0).Item("KhoNhap2").ToString()
            '        'End If
            '    End If
            'Else
            '    p_KV1_LenhxuatKho.Parameters.Item("KhoNhap").Value = "" ' DtTable.Rows(0).Item("DVNhanHang").ToString
            ...
            'If UCase(Mid(DtTable.Rows(0).Item("MaNguon").ToString, 1, 3)) = "N05" Then
            '    If DtTable.Rows(0).Item("MaTuyenDuong").ToString.Trim <> "" And DtTable.Rows(0).Item("MaTuyenDuong").ToString.Trim = "6630CH" Then
            '        p_KV1_LenhxuatKho.Parameters.Item("DonViNhanHang").Value = DtTable.Rows(0).Item("DVNhanHang2").ToString
            '    Else
            ...
            p_KV1_LenhxuatKho.Parameters.Item("PhuongThucVanTai").Value = DtTable.Rows(0).Item("PhuongThucVanTai").ToString
            If DtTable.Rows(0).Item("SoChuyenVanTai").ToString = "V144" Or DtTable.Rows(0).Item("SoChuyenVanTai").ToString = "" Then
    ...
    Public Function Print_LENHXUATKHOKDDA4(ByVal i_preview As Boolean, ByVal i_SoLenh As String, ByRef o_err As String) As Boolean
        ...
        Try
            ...
            p_KV1_LenhxuatKho.Parameters.Item("DonViCungCapVanTai").Value = DtTable.Rows(0).Item("DonViCungCapVanTai")
            p_KV1_LenhxuatKho.Parameters.Item("KhoXuat").Value = DtTable.Rows(0).Item("KhoXuat").ToString
            p_KV1_LenhxuatKho.Parameters.Item("KhoNhap").Value = DtTable.Rows(0).Item("KhoNhap").ToString      ' "Kho 100 hieptd4" 'hieptd4 add for test
            'p_KV1_LenhxuatKho.Parameters.Item("p_GhiChu").Value = "Anh hùng bàn phím ahihi" 'hieptd4 add for test
            'p_KV1_LenhxuatKho.Parameters.Item("p_NguoiLap").Value = g_UserName
            p_SQL = "select top 1 DESCRIPTION from SYS_USER with (Nolock) where USER_NAME='" & g_UserName & "'"
            p_DataTable = g_Services.Sys_SYS_GET_DATATABLE_Des(p_SQL, p_SQL)
            ...
            'p_KV1_LenhxuatKho.Parameters.Item("p_TongDuXuat").Value = TongDuXuat
            'p_KV1_LenhxuatKho.Parameters.Item("p_TongThucXuat").Value = TongThucXuat
            p_KV1_LenhxuatKho.Parameters.Item("p_datetime").Value = "Ngày giờ in: " & String.Format("{0:dd.MM.yyyy}", p_Date) & " . " & p_Date.Hour.ToString + ":" + p_Date.Minute.ToString + ":" + p_Date.Second.ToString
