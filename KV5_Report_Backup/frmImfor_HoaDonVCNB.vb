Public Class frmImfor_HoaDonVCNB
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        ...
        Try
            ...
            rpt.SetParameterValue("P_NgayDieuDong", srt_dieudong.Substring(0, 2))
            rpt.SetParameterValue("P_ThangDieuDong", srt_dieudong.Substring(3, 2))
            rpt.SetParameterValue("P_NamDieuDong", srt_dieudong.Substring(6, 4))

            'rpt.SetParameterValue("P_Nam", srt_dt.Substring(8, 2))

            rpt.SetParameterValue("P_SoLenh", txtSoLenh.Text.Trim())
            rpt.SetParameterValue("P_CuaDonVi", txtCompany.Text)
            rpt.SetParameterValue("P_DonViGiaoHang", txtDonViGiaoHang.Text)
            rpt.SetParameterValue("P_DonViGiaoHangDiaChi", txtDiaChiDonViGiaoHang.Text)
            ...
            rpt.SetParameterValue("P_KhoNhap", txtKhoNhap.Text)
            rpt.SetParameterValue("P_DonViCCVanTai", txtDonViCungCapVanTai.Text)
            ...
            rpt.SetParameterValue("P_GioXuatHang", String.Format("{0}:{1}:{2}", times.Hour, times.Minute, times.Second))
    ...
    Private Sub Update_TTHoaDon()
        ...
        Try
            ...
            p_SQL = " exec DonViUpdateAddress '" & txtDiaChiDonViGiaoHang.Text & "'"
            If SQL_Execute(p_SQL, p_SQL) = False Then
                ShowMessageBox("", p_SQL)
                Exit Sub
            End If
            ...
            p_SQL = " exec KhachHangUpdateAddress '" & Provider.Rows(0).Item(3).ToString.Trim & "','" & txtDiaChiDonViNhanHang.Text & "'"
            If SQL_Execute(p_SQL, p_SQL) = False Then
                ShowMessageBox("", p_SQL)
                Exit Sub
            End If
