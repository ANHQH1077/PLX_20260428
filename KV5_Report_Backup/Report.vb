Module Report
    ...
    'Public Function Get_HoaDon_TaiXuatChiTietNew(ByVal i_SoLenh As String) As DataTable
    '    Dim err As String = String.Empty
    '    Dim DtTable As DataTable
    '    Dim p_SQL As String
    '    Try
    '        p_SQL = "exec FPT_Reports_HoaDonTaiXuatE5 '" & i_SoLenh & "'"
    '        DtTable = GetDataTable(p_SQL, p_SQL)
    '        DtTable = Alter_table_HoaDon(DtTable)
    '        Return DtTable
    '    Catch ex As Exception
    ...
    Public Function Alter_table_HoaDon(ByVal i_dtTable As DataTable) As DataTable
        ...
        For Each r As DataRow In dtHoaDon.Rows
            ...
            Dim _L15 As Decimal() = mdlQCI_CalculateQCI_NS(Decimal.Parse(IIf(IsDBNull(r.Item("TổngXuất")), 0, r.Item("TổngXuất").ToString)), r.Item("ĐơnVịTính").ToString, Decimal.Parse(IIf(IsDBNull(r.Item("NhiệtĐộ")), 0, r.Item("NhiệtĐộ").ToString)), r.Item("TỷTrọng").ToString)
            l15 = _L15(1).ToString
            kg = _L15(3).ToString
            'Else
