...
Partial Class FrmTankGroupHist
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTankGroupHist))
        ...
        Me.TrueDBGrid1.RepositoryItems.AddRange(New DevExpress.XtraEditors.Repository.RepositoryItem() {Me.RepositoryItemButtonEdit1, Me.RepositoryItemButtonEdit2, Me.RepositoryItemComboBox1, Me.RepositoryItemComboBox2})
        ...
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.Name_nd, Me.Product_nd, Me.TenHangHoa, Me.TankGroup, Me.FromDate, Me.ToDate, Me.CreateUser, Me.CreateDate, Me.UpdateUser, Me.UpdateDate, Me.sType, Me.CrDate, Me.TichHop, Me.ID})
        ...
        Me.GridView1.OrderBy = "Name_nd, FromDate"
        Me.GridView1.ParentItem = Nothing
        Me.GridView1.RowNumber = ""
        Me.GridView1.TableName = ""
        Me.GridView1.ViewName = "tblTankGroup_HIST"
        ...
        Me.CreateUser.VisibleIndex = 6
        Me.CreateUser.Width = 88
        '
        'CreateDate
        '
        ...
        Me.UpdateUser.VisibleIndex = 8
        Me.UpdateUser.Width = 88
        '
        'UpdateDate
        '
        ...
        Me.sType.SQLString = "select 'I' as Code, N'Thêm mới' as sDesc union all select 'U' as Code, N'Sửa' as " & _
            "sDesc union all select 'D' as Code, N'Xóa' as sDesc"
        ...
        Me.CrDate.Caption = "Ngày thực hiện"
        ...
        Me.CrDate.OptionsColumn.ReadOnly = True
