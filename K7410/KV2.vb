...
Module KV2
    ...
    Public Function mdlTichke_new_PrintTrans(ByVal i_Preview As Boolean, _
        ...
        Try
            ...
            p_Rpt.Parameters.Item("p_CompanyName").Value = "Công Ty TNHH MTV Xăng Dầu Bà Rịa Vũng Tàu" ' g_TenDonVi
            ...
            p_Rpt_A3.Parameters.Item("p_CompanyName").Value = "Công Ty TNHH MTV Xăng Dầu Bà Rịa Vũng Tàu" '  g_TenDonVi
            p_Rpt_A3.Parameters.Item("DiemTraHang").Value = i_dt_trans.Rows(0).Item("DiemtraHang").ToString


            p_Rpt_A3.Parameters.Item("KhoXuat").Value = g_WareHouseName
            'p_Rpt.Parameters.Item("p_Day").Visible = False
            'p_Rpt.Parameters.Item("p_Year").Visible = False
            ...
            p_RptThuy.Parameters.Item("p_CompanyName").Value = "Công Ty TNHH MTV Xăng Dầu Bà Rịa Vũng Tàu" 'g_TenDonVi
