...
Module Report
    ...
    Public Sub mdlRptTTLenhXuat(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        ...
        End With
        p_Report.XrLabel1.Text = p_ParentCompanyName
        p_Report.ShowPreviewDialog()
    ...
    Public Sub mdlRptBM_01_32_B12(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
        ...
        Dim p_Left_Title As Integer
        Dim p_Top_Title As Integer
        Dim p_Report As New RptBM_01_32New
        Dim p_Row As DataRow
        Dim StrParameter As String = ""
        Dim p_Object() As Object
    ...
    Public Sub mdlRptBM_03_01(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
        ...
        Dim p_Left_Title As Integer
        Dim p_Top_Title As Integer
        Dim p_Report As New RptBM_03_01
        Dim p_Row As DataRow
        Dim StrParameter As String = ""
        Dim p_Object() As Object
        Dim dtTable As DataTable = p_datatable
        ...
        If Not p_TableCompany Is Nothing Then
            If p_TableCompany.Rows.Count > 0 Then
                ...
                p_Report.XrLabel1.Text = p_ParentCompanyName
                p_Report.p_CompanyName.Value = p_CompanyName
                p_Report.p_CompanyName.Visible = False
            End If
        ...
        With p_Report
            ...
            p_Top_Title = 110
            'Lay ra cac tham so co the treo len bao cao
            p_Arr = g_SYS_CONFIG_RPT_PARA.Select("ReportCode='" & p_ReportCode & "' ", "STT")
            If p_Arr.Length > 0 Then
                For p_Count = 0 To p_Arr.Length - 1
                    p_Row = p_Arr(p_Count)
                    StrParameter = ""
        ...
        p_Report.Detail1.Visible = False
        p_Report.ShowPreviewDialog()
    ...
    Public Sub mdlRptBM_03_02(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
        ...
        Dim p_Left_Title As Integer
        Dim p_Top_Title As Integer
        Dim p_Report As New RptBM_03_02
        Dim p_Row As DataRow
        Dim StrParameter As String = ""
        Dim p_Object() As Object
        Dim dtTable As DataTable = p_datatable
    ...
    Public Sub mdlRptBM_03_03(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
        ...
        Dim p_Left_Title As Integer
        Dim p_Top_Title As Integer
        Dim p_Report As New RptBM_03_03
        Dim p_Row As DataRow
        Dim StrParameter As String = ""
        Dim p_Object() As Object
        Dim dtTable As DataTable = p_datatable
    ...
    Public Sub mdlRptBM_05_04_01(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        ...
        If Not p_TableCompany Is Nothing Then
            If p_TableCompany.Rows.Count > 0 Then
                ...
                '            p_TyTrongTT = mdlQCI_GetDTT_NS(p_datatable.Rows(p_count1).Item("MaHangHoa").ToString.Trim, _
                '                                            p_datatable.Rows(p_count1).Item("NhietDo").ToString.Trim, _
                '                                            p_datatable.Rows(p_count1).Item("TyTrong").ToString.Trim)

                '            p_datatable.Rows(p_count1).Item("TyTrongTT") = p_TyTrongTT
                '        Next
                '    End If
                'End If
    ...
    Public Sub mdlRptBM_05_04_02(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
        ...
        Dim p_Left_Title As Integer
        Dim p_Top_Title As Integer
        Dim p_Report As New RptBM_05_04_01_02
        Dim p_Row As DataRow
        Dim StrParameter As String = ""
        Dim p_Object() As Object
        Dim dtTable As DataTable = p_datatable
        ...
        p_Report.XrLabel22.Text = p_Title
        'p_Report.lbCompany.Text = p_CompanyName
        'p_Report.lbParent.Text = p_ParentCompanyName
        p_Report.DataSource = p_datatable
        p_Report.DatePrint.Value = "Date: " & Now.Date.ToString("dd/MM/yyyy")
        p_SQL = "select * from SYS_CONFIG_RPT_FOOTER where ReportCode='" & p_ReportCode & "' ORDER BY  ISNULL(RowNum,0)"
        p_DataTable1 = GetDataTable(p_SQL, p_SQL)
    ...
    Public Sub mdlRptBM_03_04(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        Dim p_ShowParent As Boolean = False
        Dim p_ShowCompany As Boolean = False
        Dim p_Title As String = ""
        Dim p_Arr() As DataRow
        ...
        Dim p_Left_Title As Integer
        Dim p_Top_Title As Integer
        Dim p_Report As New RptBM_03_04
        Dim p_Row As DataRow
        Dim StrParameter As String = ""
        Dim p_Object() As Object
        Dim dtTable As DataTable = p_datatable
    ...
    Public Sub InBienBanGiaoNhan(ByVal p_SoLenh As String)
        ...
        Dim p_Report As New BienBanGiaoNhanNew
        ...
        p_SQL = "exec dtBienBanGiaoNhan_MauMoi '" & p_SoLenh & "'"
