...
Module Module2
    ...
    Public Sub mdlRptBM_01_14_BienBan(ByVal p_datatable As DataTable, ByVal p_ReportCode As String)
        ...
        'p_KV1_LenhxuatKho.XrLabel1.Text = DtTable2.Rows(0).Item("ComName").ToString.Trim
        'p_KV1_LenhxuatKho.XrLabel23.Text = DtTable2.Rows(0).Item("MaSo").ToString.Trim & vbCrLf & _
        '        DtTable2.Rows(0).Item("LanBH").ToString.Trim & vbCrLf & DtTable2.Rows(0).Item("NgayBH").ToString.Trim
