...
Public Class Class1
    ...
    Public Function clsPrint_BienBanDoBe(ByVal i_preview As Boolean, ByVal i_SoLenh As String, ByRef o_err As String) As Boolean
        clsPrint_BienBanDoBe = Print_BienBanDoBe(i_preview, i_SoLenh, o_err)
    End Function
        ...
        Select Case p_ReportCode
            Case "BM_01_32"
                If g_Company_Code = "2610" Then
                    mdlRptBM_01_32_B12(p_Form, p_datatable, p_ReportCode)
                Else
            ...
            Case "BM_03_01"
                mdlRptBM_03_01(p_Form, p_datatable, p_ReportCode)
            Case "BM_03_02"
                mdlRptBM_03_02(p_Form, p_datatable, p_ReportCode)
            Case "BM_03_03"
                mdlRptBM_03_03(p_Form, p_datatable, p_ReportCode)
            Case "BM_03_04"
                mdlRptBM_03_04(p_Form, p_datatable, p_ReportCode)
            Case "BM_05_04_01"
                mdlRptBM_05_04_01(p_Form, p_datatable, p_ReportCode)
            Case "BM_05_04_02"
                mdlRptBM_05_04_02(p_Form, p_datatable, p_ReportCode)
            Case "BM_01_14_BB"
    ...
    Public Sub clsInBaoCaoNew(ByVal p_Form As U_CusForm.XtraCusForm1, ByVal p_datatable As DataTable, ByVal p_ReportCode As String,
        ...
        'Dim g_SYS_CONFIG_RPT_FIELD As DataTable
        g_SYS_CONFIG_RPT_PARA = p_SYS_CONFIG_RPT_PARA
        g_SYS_CONFIG_RPT = p_SYS_CONFIG_RPT
        g_SYS_CONFIG_RPT_FIELD = p_SYS_CONFIG_RPT_FIELD
