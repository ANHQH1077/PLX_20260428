...
Module KV2
    ...
    Public Function mdlTichke_new_PrintTrans(ByVal i_Preview As Boolean, _
        ...
        Try
            ...
            Else
                p_Rpt2540.Parameters.Item("p_Day").Value = CDate(i_dt_trans.Rows(0).Item("NgayXuat")).ToString("dd")
                p_Rpt2540.Parameters.Item("p_Month").Value = CDate(i_dt_trans.Rows(0).Item("NgayXuat")).ToString("MM")
                p_Rpt2540.Parameters.Item("p_Year").Value = CDate(i_dt_trans.Rows(0).Item("NgayXuat")).ToString("yyyy")
                p_Rpt2540.Parameters.Item("p_CompanyName").Value = g_TenDonVi

                'p_Rpt.Parameters.Item("p_Day").Visible = False
                'p_Rpt.Parameters.Item("p_Year").Visible = False
                'p_Rpt.Parameters.Item("p_Month").Visible = False
                p_Rpt2540.RequestParameters = False
                ...
                If i_Preview Then
                    If i_dt_trans.Rows(0).Item("Bo").ToString().Trim() = "X" Then
                        ...
                        p_Rpt2540.PrinterName = g_DefaultPrint
                        p_Rpt2540.DataSource = i_dt_trans
                        p_Rpt2540.Print()
                    Else
                        p_RptThuy.PrinterName = g_DefaultPrint
                        p_RptThuy.DataSource = i_dt_trans
