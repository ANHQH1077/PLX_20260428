Public Class frmImfor_HoaDonHangGiuHo
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        ...
        Try
            ...
            p_SQL = "select TenDonVi, DiaChiFull, MaSoThue from tblDonVi  where MaDonVi in (select CompanyCode from tblConfig )"
            p_table = GetDataTable(p_SQL, p_SQL)
            If Not p_table Is Nothing Then
                If p_table.Rows.Count > 0 Then
                    rpt.XrCongTy.Text = p_table.Rows(0).Item("TenDonVi").ToString
                    rpt.XrDiaChi.Text = p_table.Rows(0).Item("DiaChiFull").ToString
                    rpt.XrMST.Text = p_table.Rows(0).Item("MaSoThue").ToString
                End If
            End If
            For p_Count = 0 To SubTable.Rows.Count - 1
                SubTable.Rows(p_Count).Item("STT") = p_Count + 1
            Next

            For p_Count = 1 To 7 - SubTable.Rows.Count
            ...
            rpt.Parameters.Item("P_CuaDonVi").Value = Me.txtCompany.Text.ToString
            ...
            Dim times As Date = Convert.ToDateTime(DtTable.Rows(0).Item("NgayHoaDon").ToString)
            ...
            For p_Count = 0 To rpt.Parameters.Count - 1
                If UCase(rpt.Parameters.Item(p_Count).Name) <> "KYHIEU" And UCase(rpt.Parameters.Item(p_Count).Name) <> "SOPHIEU" Then
