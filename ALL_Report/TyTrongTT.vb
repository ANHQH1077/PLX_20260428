Module TyTrongTT
    ...
    Public Function mdlQCI_GetDTT_NS(ByVal p_HangHoaE5 As Boolean, ByVal i_temp As String, _
        ...
        l_dens_1 = mdlQCI_ConvertDens_1E5(l_dens, l_temp)
        l_dens_2 = mdlQCI_ConvertDens_2E5(l_dens, l_temp)
    ...
    Private Function mdlQCI_ConvertDens_1E5(ByVal i_dens As String, NhietDo As String) As String
        Try
            Dim l_dens_0 As String = "0"
            Dim l_dens_1 As String = "0"
            Dim l_dens_2 As String = "0"
            ...
            p_SQL = "select Max (TyTrong15) TyTrong151 from tblTyTrong15E5 with (Nolock) where NhietDoTT=" & NhietDo & " and TyTrong15<= " & i_dens
            p_Table = GetDataTable(p_SQL, p_SQL)
            If Not p_Table Is Nothing Then
                If p_Table.Rows.Count > 0 Then
                    l_dens_1 = p_Table.Rows(0).Item(0).ToString.Trim
            ...
            If l_dens_1 <> "0" Then
                Return l_dens_1
            End If
            'p_SQL = "select Min (TyTrong15) TyTrong151 from tblTyTrong15E5 with (Nolock) where NhietDoTT=" & NhietDo & " and TyTrong15 > =" & i_dens
            'p_Table = GetDataTable(p_SQL, p_SQL)
            'If Not p_Table Is Nothing Then
            '    If p_Table.Rows.Count > 0 Then
            '        l_dens_2 = p_Table.Rows(0).Item(0)

            '    End If
            'End If
            'p_Table = Nothing

            'If l_dens_1 <> "0" And l_dens_2 <> "0" Then
            '    p_SQL = "select Max (TyTrong15) TyTrong151 from tblTyTrong15E5 with (Nolock) where NhietDoTT=" & NhietDo & " and TyTrong15  in (" & l_dens_1 & "," & l_dens_2 & ") "
            '    p_Table = GetDataTable(p_SQL, p_SQL)
            '    If Not p_Table Is Nothing Then
            '        If p_Table.Rows.Count > 0 Then
            '            l_dens_0 = p_Table.Rows(0).Item(0)
    ...
    Private Function mdlQCI_ConvertDens_2E5(ByVal i_dens As String, NhietDo As String) As String
        Try
            ...
            If Not p_Table Is Nothing Then
                If p_Table.Rows.Count > 0 Then
                    l_dens_2 = p_Table.Rows(0).Item(0).ToString.Trim
