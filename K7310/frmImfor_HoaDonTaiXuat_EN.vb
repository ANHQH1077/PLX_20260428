Public Class frmImfor_HoaDonTaiXuat_EN
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        ...
        Try
            ...
            rpt.Parameters.Item("p_PXK").Value = "According to PXK no. " + txtSoPXK.Text + " - " + Format(txtNgayPXK.EditValue, "ddMMyyyy").ToString
            ...
            Dim times As Date = DtTable.Rows(0).Item("NgayXuat").ToString
    ...
    Sub HoaDonGTGT_VN()
        ...
        Try
            ...
            rpt.Parameters.Item("P_TKHQ").Value = txtToKhaiHQ.Text
            rpt.Parameters.Item("P_STK").Value = txtSoTK.Text
            rpt.Parameters.Item("p_PXK").Value = "Theo PXK số " + txtSoPXK.Text + " - " + Format(txtNgayPXK.EditValue, "ddMMyyyy").ToString
