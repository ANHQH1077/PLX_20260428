...
Public Class SCADAR_HTTG_ACC
    'p_TypeIn=out hoac in

    Private p_ObjAccess As New HTTG_SCADAR_ACC
            ...
            If Not p_DataSet Is Nothing Then
                If p_DataSet.Tables.Count > 0 Then
                    ...
                    If g_ACCESS_PASS <> "" Then
                        g_ACCESS_PASS = p_ObjAccess.mdlCryptor_Decrypt(g_ACCESS_PASS, g_ACCESS_USER)
                    End If
...
HoangHoaPhaChe:
    ...
    Private Function BuildTbaleUpdateHTTG(ByVal g_LoaiVanChuyen As String, _
        ...
        Try
            ...
            If p_DataTableExe.Rows.Count > 0 Then
                    ...
                    If g_ConnectHTTG.Sys_Execute_DataTbl(p_DataTableExe, p_SQL) = False Then
                        'MsgBox(p_SQL)
                        p_Desc = p_SQL
    ...
    Private Function mdlQCI_GetVCFSub_NSE5(ByVal i_temp As String, _
        ...
        Try
            ...
            l_dt = g_ConnectHTTG.p_SYS_GET_DATATABLE_Des(l_sql, l_sql)
...
HoangHoaPhaChe:
    ...
    Public Function UnionDateTime_Fox(ByVal p_Date As Date, ByVal p_Time As String) As DateTime
        ...
        Catch ex As Exception
            Try
                p_Value = ""
                p_Time = CDate(p_Time).ToString("hh:mm:ss tt")
                p_Value = p_Date.ToString("MM/dd/yyyy") & " " & p_Time
                UnionDateTime_Fox = CDate(p_Value)
    ...
    Public Sub GetPathFileAccess_DB(ByRef p_FoxOut As String, ByRef p_FoxIn As String, ByRef p_FoxTemp As String, ByRef pUser As String, ByRef p_Pass As String)
        ...
        If Not p_Table Is Nothing Then
            If p_Table.Rows.Count > 0 Then
                ...
                p_PassFileAcc = p_ObjAccess.mdlCryptor_Decrypt(p_PassFileAcc, p_UserFileAcc)
