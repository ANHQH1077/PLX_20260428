...
Public Class Class1
    ...
    Public Function mdlTichke_new_AutoComparment_Thuy(ByVal i_dt_vehicle As DataTable, ByVal i_dt_header As DataTable, ByRef o_dt_compartment As DataTable) As Boolean
...
#Region "Tu dong chi ngan"
    Public Sub Load1(ByVal p_dt_vehicle As System.Data.DataTable, ByVal p_PhuongTien As String, ByVal p_TableLine As System.Data.DataTable, _
    ...
    Public Sub TuDongChiaNgan(ByVal p_LoaiXuat As String)
