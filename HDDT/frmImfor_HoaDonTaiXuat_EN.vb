Public Class frmImfor_HoaDonTaiXuat_EN
    ...
    Private p_LoaiChungTu As String = "HDTX_VN"
    ...
    Private Sub frmImfor_HoaDonTaiXuat_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        p_txtDonViNhanHang = p_DataTable.Rows(0).Item("TenKhachHang").ToString()
        p_txtDiaChiDonViNhanHang = p_DataTable.Rows(0).Item("DiaChi").ToString()


        p_Text2 = p_DataTable.Rows(0).Item("TexBox2").ToString()
        p_Text1 = p_DataTable.Rows(0).Item("TexBox1").ToString()
        ...
        p_NgayVanDon = CDate(p_DataTable.Rows(0).Item("NgayVanDon").ToString())
        ...
        Me.dtNgayXuat.EditValue = CDate(p_DataTable.Rows(0).Item("NgayHoaDon").ToString()) ' p_Date 'Now.Date 'hieptd4 edit 20161206
        ' End If

        '  Me.dtNgayXuat.EditValue = p_Date
        If Me.txtToKhaiHQ.Text = "" Then
            txtToKhaiHQ.EditValue = p_DataTable.Rows(0).Item("SoTKHQNhap").ToString()
        End If

        '  txtToKhaiHQ.EditValue = p_DataTable.Rows(0).Item(15).ToString()
        If Me.txtSoTK.Text = "" Then
            txtSoTK.EditValue = p_DataTable.Rows(0).Item("SoTKHQXuat").ToString()
        End If
        'txtSoTK.EditValue = p_DataTable.Rows(0).Item(16).ToString()
        If Me.txtPhuongThuc.Text = "" Then
            txtPhuongThuc.EditValue = p_DataTable.Rows(0).Item("PhuongThucThanhToan").ToString()
        End If

        'txtSoTK.EditValue = p_DataTable.Rows(0).Item(16).ToString()
        If Me.txtThoiHanThanhToan.Text = "" Then
            txtThoiHanThanhToan.EditValue = p_DataTable.Rows(0).Item("ThoiHanThanhToan").ToString()
        End If



        If Me.TextBox2.Text = "" Then
            TextBox2.EditValue = p_Text2
        End If

        If Me.TextBox1.Text = "" Then
            TextBox1.EditValue = p_Text1
        End If
        ...
        'txtSoTK.EditValue = p_DataTable.Rows(0).Item(16).ToString()
        If Me.Ngay_TKTX.Text = "" Then

            If p_DataTable.Rows(0).Item("Ngay_TKTX").ToString.Trim <> "" Then
                Ngay_TKTX.EditValue = CDate(p_DataTable.Rows(0).Item("Ngay_TKTX")) '.ToString()
            End If

        End If

        If Me.NgayVanDon.Text = "" Then

            ' If p_DataTable.Rows(0).Item("Ngay_TKTX").ToString.Trim <> "" Then
            Me.NgayVanDon.EditValue = p_NgayVanDon    ' CDate(p_DataTable.Rows(0).Item("Ngay_TKTX")) '.ToString()
            'End If
