Public Class frmImfor_HoaDonVCNB_CIF
    ...
    Private p_LoaiChungTu As String = "GTGT_VCNB_DCCH"
    ...
    Private Sub frmImfor_HoaDonVCNB_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        p_txtCompany = Replace(p_txtCompany, "VP ", "")

        p_txtDonViGiaoHang = Replace(p_txtCompany, "VP ", "")  ''Provider_TK.Rows(0).Item("TenDonVi").ToString()
        p_txtDiaChiDonViGiaoHang = Provider.Rows(0).Item(1).ToString()  ' Provider_TK.Rows(0).Item("DiaChiFull").ToString()



        txtDonViGiaoHang.Text = p_txtDonViGiaoHang
        ...
        'End If
        ' txtDonViNhanHang.Text = "XN Bán lẻ XD KV2"
        'txtDiaChiDonViNhanHang.Text = "15 Lê Duẩn, Quận 1, Hồ Chí Minh"
        ...
        If W_DSET.Tables(0).Rows(0).Item("MaNguon").ToString() = "N30" Then
            Me.txtDiemGiaoHang.Text = ""
            Me.txtKhoNhap.Text = ""
            Me.txtDiemGiaoHang.Enabled = False
            Me.txtKhoNhap.Enabled = False
        End If
    ...
    '            p_RpHoaDonVCNB.Parameters.Item("P_DonViGiaoHangDiaChi").Value = txtDiaChiDonViGiaoHang.Text & "-VN"
    '            p_RpHoaDonVCNB.Parameters.Item("P_DonViMua").Value = txtDonViNhanHang.Text
    '            p_RpHoaDonVCNB.Parameters.Item("P_DiaChi_MH").Value = txtDiaChiDonViNhanHang.Text & "-VN"
    ...
    '            p_RpHoaDonVCNB.Parameters.Item("P_GioXuatHang").Value = Format(times, "HH:mm:ss") ' String.Format("{0}:{1}:{2}", times.Hour, times.Minute, times.Second)
    ...
    '                If (DtTable.Rows(0).Item("MaPhuongThucBan").ToString.Trim = "05" Or DtTable.Rows(0).Item("MaPhuongThucBan").ToString.Trim = "06") _
    '                        And (DtTable.Rows(0).Item("MaNguon").ToString.Trim = "N05" Or DtTable.Rows(0).Item("MaNguon").ToString.Trim = "N05") Then
    '                    p_RpHoaDonVCNB.XrLabel31.Text = ""
    '                    GoTo Line_TT
    '                End If
    ...
    '                If (Mid(SubTable.Rows(0).Item("MaHangHoa").ToString.Trim, 1, 4) = "0101") Then
    '                    p_RpHoaDonVCNB.XrLabel31.Text = ""
    '                    GoTo Line_TT
    '                End If
        ...
        Try
            ...
            If dtTable.Rows.Count > 0 Then
                For Each r As DataRow In dtTable.Rows
                    ...
                    'dtRow("TenHangHoa") = r.Item("TenHangHoa").ToString 'hieptd4 comment
                    dtRow("TenHangHoa") = r.Item("MaHangHoa").ToString & " - " & r.Item("TenHangHoa").ToString 'hieptd4 fix theo toanNT11: so sánh với in trên SAP
    ...
    Private Function ND_VCF(ByVal LTT As String, ByVal productID As String, ByVal unitID As String, ByVal dgvRow As Integer, Optional p_MaVanChuyen As String = "ZT") As String
        ...
        Try
            ...
            '                Hed = "Nhiệt độ TT/L15/KG/D15/VCF/WCF: "
