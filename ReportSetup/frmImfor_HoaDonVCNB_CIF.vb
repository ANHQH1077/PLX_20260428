Public Class frmImfor_HoaDonVCNB_CIF
    ...
    Private Sub frmImfor_HoaDonVCNB_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        txtKhoNhap.EditValue = W_DSET.Tables(0).Rows(0).Item("KhoNhap").ToString() 'hieptd4 add 20161102
        ...
        If Not Me.txtDiemGiaoHang.EditValue Is Nothing Then
            If Me.txtDiemGiaoHang.EditValue.ToString.Trim = "" Then
                Me.txtDiemGiaoHang.EditValue = W_DSET.Tables(0).Rows(0).Item("DiemTraHang").ToString()
            End If
        Else
            Me.txtDiemGiaoHang.EditValue = W_DSET.Tables(0).Rows(0).Item("DiemTRaHang").ToString()
        End If
        If Not Me.txtKhoNhap.EditValue Is Nothing Then
            If Me.txtKhoNhap.EditValue.ToString.Trim = "" Then
                Me.txtKhoNhap.EditValue = W_DSET.Tables(0).Rows(0).Item("KhoNhap").ToString()
            End If
        Else
            Me.txtKhoNhap.EditValue = W_DSET.Tables(0).Rows(0).Item("KhoNhap").ToString()
        End If
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        ...
        Try
            ...
            InChungTuHoaDon_VCNB_CIF(Me, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
    ...
    Private Sub InChungTuHoaDon_VCNB_CIF(ByVal p_Form As Object, ByVal W_SoLenh As String, _
        ...
        Select Case g_Company_Code
            ...
            Case "4510" 'KV5
                Dim p_TichKeKV5 As New K4510.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_TichKeKV5.clsHoaDon_VCNB_CIF(p_Form, W_SoLenh, _
                                   DtTable, _
                                     DtTable1, _
                                     DtTable2,
                                     SubTable, _
            ...
            Case "1410"
                Dim p_1410 As New K1410.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_1410.clsHoaDon_VCNB_CIF(p_Form, W_SoLenh, _
                               DtTable, _
                                 DtTable1, _
                                 DtTable2,
                                 SubTable, _
            ...
            Case "1910"
                Dim p_1910 As New K1910.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_1910.clsHoaDon_VCNB_CIF(p_Form, W_SoLenh, _
                               DtTable, _
                                 DtTable1, _
                                 DtTable2,
                                 SubTable, _
            ...
            Case "2010"
                Dim p_2010 As New K2010.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2010.clsHoaDon_VCNB_CIF(p_Form, W_SoLenh, _
                               DtTable, _
                                 DtTable1, _
                                 DtTable2,
                                 SubTable, _
            ...
            Case "2210"
                Dim p_2210 As New K2210.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2210.clsHoaDon_VCNB_CIF(p_Form, W_SoLenh, _
                                DtTable, _
                                  DtTable1, _
                                  DtTable2,
                                  SubTable, _
            ...
            Case "2310"
                Dim p_2310 As New K2310.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2310.clsHoaDon_VCNB_CIF(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "2510"
                ...
                p_2510.clsHoaDon_VCNB_CIF(p_Form, W_SoLenh, _
                                DtTable, _
                                  DtTable1, _
                                  DtTable2,
                                  SubTable, _
            ...
            Case "2610"
                ...
                p_2610.clsHoaDon_VCNB_CIF(p_Form, W_SoLenh, _
                                DtTable, _
                                  DtTable1, _
                                  DtTable2,
                                  SubTable, _
            ...
            Case "6410"
                ...
                p_6410.clsHoaDon_VCNB_CIF(p_Form, W_SoLenh, _
                                DtTable, _
                                  DtTable1, _
                                  DtTable2,
                                  SubTable, _
            ...
            Case "2810"
                Dim p_2810 As New K2810.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2810.clsHoaDon_VCNB_CIF(p_Form, W_SoLenh, _
                                DtTable, _
                                  DtTable1, _
                                  DtTable2,
                                  SubTable, _
            ...
            Case "4810"
                Dim p_4810 As New K4810.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_4810.clsHoaDon_VCNB_CIF(p_Form, W_SoLenh, _
                                DtTable, _
                                  DtTable1, _
                                  DtTable2,
                                  SubTable, _
    ...
    Private Function ND_VCF_Luu(ByVal LTT As String, ByVal productID As String, ByVal unitID As String, ByVal dgvRow As Integer) As String
        ...
        Try
            ...
            p_Double = p_DataRow.Item("NhiệtĐộ").ToString()
            ND = p_Double.ToString.Trim  ' p_DataRow.Item("NhiệtĐộ").ToString()
            '   ND = Format(ND, "n2").ToString 'hieptd4 add
