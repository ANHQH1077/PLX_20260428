Public Class frmImfor_HoaDonVCNB
    ...
    Private Sub frmImfor_HoaDonVCNB_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        txtDonViGiaoHang.Text = p_txtDonViGiaoHang ' Provider.Rows(0).Item(0).ToString()
        txtDiaChiDonViGiaoHang.Text = p_txtDiaChiDonViGiaoHang ' Provider.Rows(0).Item("DiaChiFull").ToString()
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        ...
        Try
            ...
            InChungTuHoaDon_VCNB(Me, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
    ...
    Private Sub InChungTuHoaDon_VCNB(ByVal p_Form As Object, ByVal W_SoLenh As String, _
        ...
        Select Case g_Company_Code
            ...
            Case "4510" 'KV5
                Dim p_TichKeKV5 As New K4510.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_TichKeKV5.clsHoaDonTaiXuat_VCNB(p_Form, W_SoLenh, _
                                   DtTable, _
                                     DtTable1, _
                                     DtTable2,
                                     SubTable, _
            ...
            Case "1410"
                Dim p_1410 As New K1410.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_1410.clsHoaDonTaiXuat_VCNB(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "1910"
                Dim p_1910 As New K1910.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_1910.clsHoaDonTaiXuat_VCNB(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "2010"
                Dim p_2010 As New K2010.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2010.clsHoaDonTaiXuat_VCNB(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "2210"
                Dim p_2210 As New K2210.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2210.clsHoaDonTaiXuat_VCNB(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "2310"
                Dim p_2310 As New K2310.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2310.clsHoaDonTaiXuat_VCNB(p_Form, W_SoLenh, _
                                   DtTable, _
                                     DtTable1, _
                                     DtTable2,
                                     SubTable, _
            ...
            Case "2510"
                ...
                p_2510.clsHoaDonTaiXuat_VCNB(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "2610"
                Dim p_2610 As New K2610.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2610.clsHoaDonTaiXuat_VCNB(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "6410"
                Dim p_6410 As New K6410.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_6410.clsHoaDonTaiXuat_VCNB(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "2810"
                Dim p_2810 As New K2810.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2810.clsHoaDonTaiXuat_VCNB(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "4810"
                ...
                p_4810.clsHoaDonTaiXuat_VCNB(p_Form, W_SoLenh, _
                                DtTable, _
                                  DtTable1, _
                                  DtTable2,
                                  SubTable, _
        ...
        Try
            ...
            If dtTable.Rows.Count > 0 Then
                For Each r As DataRow In dtTable.Rows
                    ...
                    '20180404
                    'dtRow("Bottom") = ND_VCF_Xitec_Option(p_SoLenh, l_quantity(0).ToString(), r.Item("MaHangHoa").ToString, r.Item("DonViTinh").ToString, index)
