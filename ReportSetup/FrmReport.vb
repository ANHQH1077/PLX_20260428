Public Class FrmReport
        ...
        If Not p_Table Is Nothing Then
            If p_Table.Rows.Count > 0 Then
                If p_Table.Rows(0).Item("KEYVALUE").ToString.Trim = "Y" Then
                    'p_ShowApp3000 = True
                    p_SQL = "select ReportCode,ReportName, STT from SYS_CONFIG_RPT  where reportCode in (select v1.reportCode from  dbo.SYS_CONFIG_RPT_GROUP v, dbo.SYS_CONFIG_RPT_GROUP1 v1 where v.code =v1.code " & _
                      " and convert(date,getdate()) >= convert(date,isnull(v1.fromdate,getdate()-5)) " & _
                      " and convert(date,getdate()) <= convert(date,isnull(v1.Todate,getdate()+5)) " & _
                      "   and   charindex(v.Code,(select ReportGroup from sys_user where upper(user_name) =upper('" & g_UserName & "')),1) >0 )"
                    Me.ReportCode.SqlString = p_SQL
                End If
            End If
        End If
        ...
        For p_Count = 0 To p_ArrRow.Length - 1
            ...
            Select Case UCase(p_ArrRow(p_Count).Item("ItemValue").ToString.Trim)
                ...
                Case UCase("Date"), UCase("Datetime")
                    ...
                    p_ITop = p_ITop + p_ItemDate.Height - 5 '+ 5
                    p_ItemDate.Top = p_ITop
                    p_ItemDate.Left = p_ILeft
                    p_ItemDate.Name = p_ArrRow(p_Count).Item("ItemName").ToString.Trim
                    If p_Required = "Y" Then
                ...
                Case UCase("TEXT")
                    Select Case UCase(p_ItemType)
                        Case "LIST"
                            ...
                            If p_ArrRow(p_Count).Item("MultiSelect").ToString.Trim = "Y" Then 'hieptd4 add 20160926
                                p_ButtonEdit.MultiSelect = True
                            End If
    ...
    Private Sub cmdRun_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRun.Click
        ...
        If p_Dynamic = "N" Then
            ...
            Else
                ...
                ExeProcedureData(True, p_SQL, p_BaoCao, p_ProcedureName, p_TableReturn, p_DataSetReturn)
            End If
        Else
            If p_LoaiBaoCao = "V" Then
            ...
            Else
                p_ProcedureName = p_RowArr(0).Item("ViewName").ToString.Trim
                ExeProcedureData(False, p_SQL, p_BaoCao, p_ProcedureName, p_TableReturn, p_DataSetReturn)
            End If
        End If
    ...
    Sub ExeProcedureData(ByVal p_RunReport As Boolean, ByRef p_SQLReturn As String, ByVal p_ReportCode As String,
                            ByVal p_ProcedureName As String, ByRef p_TableReturn As DataTable, ByRef p_DataSetReturn As DataSet)
        Dim p_SQL As String
        Dim p_Table As DataTable
        Dim p_BindingSource As New U_TextBox.U_BindingSource
        ' Dim p_ReportCode As String = ""
        ...
        Try
                    ...
                    If Not p_Object(0).editValue Is Nothing Then
                        ...
                        If p_Value <> "" Then
                            Select Case UCase(p_ArrRow(p_count).Item("ItemValue"))
                                ...
                                Case "DATETIME"
                                    If p_Where = "" Then
                                        p_Where = "'" & CDate(p_Object(0).editValue).ToString("yyyyMMdd HH:mm") & "'"
                                    Else
                                        p_Where = p_Where & ",'" & CDate(p_Object(0).editValue).ToString("yyyyMMdd HH:mm") & "'"
                                    End If
                                    'end
                                    'Case "TIME"
                                    '    If p_Where = "" Then
                                ...
                                Case "TEXT"
                                    If p_Where = "" Then
                                        p_Where = "N'" & p_Object(0).editValue.ToString.Trim & "'"
                                    Else
                                        p_Where = p_Where & ",N'" & p_Object(0).editValue.ToString.Trim & "'"
                                    End If
                                Case "TIME"
                                    If p_Where = "" Then
            ...
            ' p_SQL = p_SQL & " WITH RECOMPILE"

            p_DataSetReturn = g_Services.Sys_SYS_GET_DATASet_Des(p_SQL, p_SQL)
            If p_RunReport = True Then
                p_SQLReturn = p_SQL
                If Not p_DataSetReturn Is Nothing Then
                    If p_DataSetReturn.Tables.Count > 0 Then
                        p_TableReturn = p_DataSetReturn.Tables(0)
                    End If
                End If
                ' p_TableReturn = p_Table
                Exit Sub
    ...
    Private Sub U_ButtonCus1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdReport.Click
        ...
        Dim p_ProcedureName As String
        Dim p_TableReturn As DataTable = Nothing
        Dim p_DataSetReturn As DataSet = Nothing
        Dim p_Dynamic As String = "N"
        ...
        If p_Dynamic = "N" Then
            ...
            'Exit Sub
            If p_Report_All = False Then


                Select Case g_Company_Code
                    Case "4110"   'Quang binh
                        Dim p_QuangBinh As New QB_Report.Class1(g_Config_XMLDatatable,
                                                                             g_Company_Code,
                                                                             g_WareHouse, g_Services, "", "", "", g_Company_Host,
                                                                             g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser,
                                                                             g_DBPass, g_CompanyAPI)
                    ...
                    Case "2110"   'KV1
                        Dim p_KV1 As New KV1_Report.Class1(g_Config_XMLDatatable, _
                                                                             g_Company_Code, _
                                                                             g_WareHouse, g_Services, "", "", "", g_Company_Host, _
                                                                             g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                                             g_DBPass, g_CompanyAPI)
                        p_KV1.clsInBaoCaoNew(Me, p_TableReturn, p_BaoCao, p_SYS_CONFIG_RPT_PARA, p_SYS_CONFIG_RPT, p_SYS_CONFIG_RPT_FIELD)
                    ...
                    Case "4510" 'KV5
                        Dim p_TichKeKV5 As New K4510.Class1(g_Config_XMLDatatable, _
                                                                  ...
                                                                  g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                                  g_DBPass, g_CompanyAPI)
                        p_TichKeKV5.clsInBaoCaoNew(Me, p_TableReturn, p_BaoCao, p_SYS_CONFIG_RPT_PARA, p_SYS_CONFIG_RPT, p_SYS_CONFIG_RPT_FIELD)
                    ...
                    Case "7310"  'TNB
                        Dim p_TichKeTNB As New K7310.Class1(g_Config_XMLDatatable, _
                                                                  ...
                                                                  g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                                  g_DBPass, g_CompanyAPI)
                        p_TichKeTNB.clsInBaoCaoNew(Me, p_TableReturn, p_BaoCao, p_SYS_CONFIG_RPT_PARA, p_SYS_CONFIG_RPT, p_SYS_CONFIG_RPT_FIELD)
                    ...
                    Case "1410"
                        Dim p_1410 As New K1410.Class1(g_Config_XMLDatatable, _
                                                                  ...
                                                                  g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                                  g_DBPass, g_CompanyAPI)
                        p_1410.clsInBaoCaoNew(Me, p_TableReturn, p_BaoCao, p_SYS_CONFIG_RPT_PARA, p_SYS_CONFIG_RPT, p_SYS_CONFIG_RPT_FIELD)
                    ...
                    Case "1910"
                        Dim p_1910 As New K1910.Class1(g_Config_XMLDatatable, _
                                                                  ...
                                                                  g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                                  g_DBPass, g_CompanyAPI)
                        p_1910.clsInBaoCaoNew(Me, p_TableReturn, p_BaoCao, p_SYS_CONFIG_RPT_PARA, p_SYS_CONFIG_RPT, p_SYS_CONFIG_RPT_FIELD)
                    Case "2010"
                        Dim p_2010 As New K2010.Class1(g_Config_XMLDatatable, _
                                                                  ...
                                                                  g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                                  g_DBPass, g_CompanyAPI)
                        p_2010.clsInBaoCaoNew(Me, p_TableReturn, p_BaoCao, p_SYS_CONFIG_RPT_PARA, p_SYS_CONFIG_RPT, p_SYS_CONFIG_RPT_FIELD)
                    ...
                    Case "2210"
                        Dim p_2210 As New K2210.Class1(g_Config_XMLDatatable, _
                                                                  ...
                                                                  g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                                  g_DBPass, g_CompanyAPI)
                        p_2210.clsInBaoCaoNew(Me, p_TableReturn, p_BaoCao, p_SYS_CONFIG_RPT_PARA, p_SYS_CONFIG_RPT, p_SYS_CONFIG_RPT_FIELD)
                    Case "2310"
                        Dim p_2310 As New K2310.Class1(g_Config_XMLDatatable, _
                                                                  ...
                                                                  g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                                  g_DBPass, g_CompanyAPI)
                        p_2310.clsInBaoCaoNew(Me, p_TableReturn, p_BaoCao, p_SYS_CONFIG_RPT_PARA, p_SYS_CONFIG_RPT, p_SYS_CONFIG_RPT_FIELD)
                    ...
                    Case "2510"
                        Dim p_2510 As New K3610.Class1(g_Config_XMLDatatable, _
                                                                  ...
                                                                  g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                                  g_DBPass, g_CompanyAPI)
                        p_2510.clsInBaoCaoNew(Me, p_TableReturn, p_BaoCao, p_SYS_CONFIG_RPT_PARA, p_SYS_CONFIG_RPT, p_SYS_CONFIG_RPT_FIELD)
                    ...
                    Case "2520"
                        Dim p_2520 As New K2520.Class1(g_Config_XMLDatatable, _
                                                                  ...
                                                                  g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                                  g_DBPass, g_CompanyAPI)
                        p_2520.clsInBaoCaoNew(Me, p_TableReturn, p_BaoCao, p_SYS_CONFIG_RPT_PARA, p_SYS_CONFIG_RPT, p_SYS_CONFIG_RPT_FIELD)
                    ...
                    Case "2610"
                        Dim p_2610 As New K2610.Class1(g_Config_XMLDatatable, _
                                                                  ...
                                                                  g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                                  g_DBPass, g_CompanyAPI)
                        p_2610.clsInBaoCaoNew(Me, p_TableReturn, p_BaoCao, p_SYS_CONFIG_RPT_PARA, p_SYS_CONFIG_RPT, p_SYS_CONFIG_RPT_FIELD)
                    ...
                    Case "2810"
                        Dim p_2810 As New K2810.Class1(g_Config_XMLDatatable, _
                                                                  ...
                                                                  g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                                  g_DBPass, g_CompanyAPI)
                        p_2810.clsInBaoCaoNew(Me, p_TableReturn, p_BaoCao, p_SYS_CONFIG_RPT_PARA, p_SYS_CONFIG_RPT, p_SYS_CONFIG_RPT_FIELD)
                    ...
                    Case "4810"
                        Dim p_4810 As New K4810.Class1(g_Config_XMLDatatable, _
                                                                  ...
                                                                  g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                                  g_DBPass, g_CompanyAPI)
                        p_4810.clsInBaoCaoNew(Me, p_TableReturn, p_BaoCao, p_SYS_CONFIG_RPT_PARA, p_SYS_CONFIG_RPT, p_SYS_CONFIG_RPT_FIELD)
                End Select
            ...
            Else
                Dim p_AllReport As New ALL_REPORT.Class1(g_Config_XMLDatatable, _
                                                                 ...
                                                                 g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                                 g_DBPass, g_CompanyAPI)
                p_AllReport.clsInBaoCaoNew(Me, p_TableReturn, p_BaoCao, p_SYS_CONFIG_RPT_PARA, p_SYS_CONFIG_RPT, p_SYS_CONFIG_RPT_FIELD)
            End If
        End If
        Cursor = Cursors.Default
        Exit Sub
    ...
    '                Case "2510"
    '                    Dim p_2510 As New K2510.Class1(g_Config_XMLDatatable, _
    '                                                              g_Company_Code, _
    '                                                              g_WareHouse, g_Services, "", "", "", g_Company_Host, _
    '                                                              g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
    '                                                              g_DBPass, g_CompanyAPI)
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        ...
        Dim p_RowArr1() As DataRow
        Dim p_ProcedureName As String
        Dim p_TableReturn As New DataTable
        Dim p_Dynamic As String = "N"
        Dim p_DataSetReturn As DataSet
