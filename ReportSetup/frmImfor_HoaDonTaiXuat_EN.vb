Public Class frmImfor_HoaDonTaiXuat_EN
    ...
    Private Sub frmImfor_HoaDonTaiXuat_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        txtDiemGiaoHang.EditValue = p_DataTable.Rows(0).Item(18).ToString()
        ...
        Me.TxtSoLenh.EditValue = p_SoLenh


        p_Value = False

        p_GetCurrentDate(p_NgayHoaDon)

        If Not Me.dtNgayHoaDon.EditValue Is Nothing Then
            If Me.dtNgayHoaDon.EditValue.ToString.Trim <> "" Then
                p_Value = True
            End If
        End If

        If p_Value = False Then
            Me.dtNgayHoaDon.EditValue = p_NgayHoaDon
        End If


        p_Value = False
        If Not Me.dtBillingDate.EditValue Is Nothing Then
            If Me.dtBillingDate.EditValue.ToString.Trim <> "" Then
                p_Value = True
            End If
        End If
        If p_Value = False Then
            Me.dtBillingDate.EditValue = CDate(p_NgayHoaDon)
        End If
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        ...
        Try
            ...
            InChungTuHoaDon_TaiXuat_En(Me, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
    ...
    Private Sub InChungTuHoaDon_TaiXuat_En(ByVal p_Form As Object, ByVal W_SoLenh As String, _
        ...
        Select Case g_Company_Code
            ...
            Case "4510" 'KV5
                Dim p_TichKeKV5 As New K4510.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_TichKeKV5.ClsHoaDonTaiXuat_En(p_Form, W_SoLenh, _
                                   DtTable, _
                                     DtTable1, _
                                     DtTable2,
                                     SubTable, _
            ...
            Case "1410"
                Dim p_1410 As New K1410.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_1410.ClsHoaDonTaiXuat_En(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "1910"
                Dim p_1910 As New K1910.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_1910.ClsHoaDonTaiXuat_En(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "2010"
                Dim p_2010 As New K2010.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2010.ClsHoaDonTaiXuat_En(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "2210"
                Dim p_2210 As New K2210.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2210.ClsHoaDonTaiXuat_En(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "2310"
                Dim p_2310 As New K2310.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2310.ClsHoaDonTaiXuat_En(p_Form, W_SoLenh, _
                                   DtTable, _
                                     DtTable1, _
                                     DtTable2,
                                     SubTable, _
            ...
            Case "2510"
                ...
                p_2510.ClsHoaDonTaiXuat_En(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "2610"
                Dim p_2610 As New K2610.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2610.ClsHoaDonTaiXuat_En(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "6410"
                Dim p_6410 As New K6410.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_6410.ClsHoaDonTaiXuat_En(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "2810"
                Dim p_2810 As New K2810.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2810.ClsHoaDonTaiXuat_En(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "4810"
                Dim p_4810 As New K4810.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_4810.ClsHoaDonTaiXuat_En(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
    ...
    Private Sub InChungTuHoaDon_TaiXuat_VN(ByVal p_Form As Object, ByVal W_SoLenh As String, _
                                ByRef DtTable As DataTable, _
                                  ByRef DtTable1 As DataTable, _
                                  ByRef DtTable2 As DataTable,
                                  ByRef SubTable As DataTable, _
        ...
        Select Case g_Company_Code
            ...
            Case "4510" 'KV5
                Dim p_TichKeKV5 As New K4510.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_TichKeKV5.ClsHoaDonTaiXuat_VN(p_Form, W_SoLenh, _
                                   DtTable, _
                                     DtTable1, _
                                     DtTable2,
                                     SubTable, _
            ...
            Case "2610"
                ...
                p_2610.ClsHoaDonTaiXuat_VN(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "2810"
                Dim p_2810 As New K2810.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2810.ClsHoaDonTaiXuat_VN(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "4810"
                Dim p_4810 As New K4810.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_4810.ClsHoaDonTaiXuat_VN(p_Form, W_SoLenh, _
                                DtTable, _
                                  DtTable1, _
                                  DtTable2,
                                  SubTable, _
    ...
    Sub HoaDonGTGT_VN()
        ...
        Try
            ...
            If Me.U_CheckBox1.Checked = True Then
                p_Check = True
            End If
            InChungTuHoaDon_TaiXuat_VN(Me, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
    ...
    Private Function ND_VCF(ByVal LTT As String, ByVal productID As String, ByVal unitID As String, ByVal dgvRow As Integer) As String
        ...
        Try
            ...
            '                Hed = "KG/L15/Nhiệt độ/VCF/WCF/D15: "

            '                'Full = Hed + ND + " / " + KG + " / " + L15 + " / " + D15 + " / " + VCF + " / " + WCF
            '                Full = Hed + KG + " / " + L15 + " / " + ND + " / " + VCF + " / " + WCF + " / " + D15

            '            Case "0701001", "0701002", "0701003"
            '                'Hed = "Nhiệt độ TT/KG/D15/VCF/WCF: "
            '                Hed = "KG/Nhiệt độ/VCF/WCF/D15: "

            '                KG = Format(CInt(p_DataRow.Item("KG").ToString()), "n0").Replace(",", ".")
            '                'Full = Hed + ND + " / " + KG + " / " + D15 + " / " + VCF + " / " + WCF
            '                Full = Hed + KG + " / " + ND + " / " + VCF + " / " + WCF + " / " + D15
            ...
            '                Hed = "Ltt/KG/Nhiệt độ/VCF/WCF/D15: "
            '                'p_TongDuXuat
            ...
            '                Full = Hed + TX + " / " + KG + " / " + ND + " / " + VCF + " / " + WCF + " / " + D15
            '        End Select
            '    Case "KG"
            '        Select Case productID.ToUpper
            '            Case "0101001", "0201001", "0201002", "0201003", "0501001", "0601001", "0601002", "0201004"
            '                'Hed = "Nhiệt độ TT/LTT/L15/D15/VCF/WCF: "
            '                Hed = "Ltt/L15/Nhiệt độ/VCF/WCF/D15: "
            '                TX = p_DataRow.Item("TổngXuất").ToString()
            '                TX = Format(CInt(TX), "n0").Replace(",", ".") 'hieptd4 add
            ...
            '                Hed = "Ltt/Nhiệt độ/VCF/WCF/D15: "

            '                TX = p_DataRow.Item("TổngXuất").ToString()
            '                TX = Format(CInt(TX), "n0").Replace(",", ".") 'hieptd4 add

            '                'Full = Hed + ND + " / " + TX + " / " + D15 + " / " + VCF + " / " + WCF
            '                Full = Hed + TX + " / " + ND + " / " + VCF + " / " + WCF + " / " + D15
