Module Module1
    ...
    Public p_Report_All As Boolean = False
    Public p_CHUNGTU_ALL As Boolean = False
    ...
    Sub ShowMessageBox(ByVal p_ErrorNum As String, ByVal p_StringMessage As String, Optional ByVal p_Type As Integer = 0)
        g_Module.ModErrExceptionNew(p_ErrorNum, p_StringMessage, p_Type)
    End Sub
