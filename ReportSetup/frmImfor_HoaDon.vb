Public Class frmImfor_HoaDon
    ...
    Private Sub frmImfor_HoaDon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Dim p_NgayHoaDon As DateTime = Now
            ...
            '    txtSoHoaDon.Text = W_dt_HoaDonTT.Rows(0)(7).ToString()
            'End If
            ...
            If Me.dtNgayXuat.Text = "" Then
                Me.dtNgayXuat.EditValue = Now.Date
            End If
            ...
            If Not Me.txtThueGTGT.EditValue Is Nothing Then
                If Me.txtThueGTGT.EditValue.ToString.Trim <> "" Then
                    If Me.txtThueGTGT.EditValue <= 0 Then
                        p_Value = True
                    End If
                Else
                    p_Value = True
    ...
    Private Sub Get_Data_Default()
        ...
        Try
            ...
            Else
                ...
                'txtThueGTGT.EditValue = 10 'hieptd4 comment 20161102
                txtThueGTGT.EditValue = Provider.Tables(0).Rows(0).Item(15).ToString  'hieptd4 add 20161102
                'txtPhuongThuc.Text = String.Empty 'hieptd4 comment 20161102
    ...
    Private Sub InChungTuHoaDon(ByVal p_Form As Object, ByVal W_SoLenh As String, _
        ...
        Select Case g_Company_Code
            Case "4110"   'Quang binh
                ...
                'p_QuangBinh.clsIn_HoaDon(p_Form, W_SoLenh, _
                '                  DtTable, _
                '                    DtTable1, _
                '                    DtTable2,
                '                    SubTable, _
            ...
            Case "4510" 'KV5
                Dim p_TichKeKV5 As New K4510.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_TichKeKV5.clsIn_HoaDon(p_Form, W_SoLenh, _
                                   DtTable, _
                                     DtTable1, _
                                     DtTable2,
                                     SubTable, _
            ...
            Case "1910"
                Dim p_1910 As New K1910.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_1910.clsIn_HoaDon(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "2010"
                Dim p_2010 As New K2010.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2010.clsIn_HoaDon(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "2210"
                Dim p_2210 As New K2210.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2210.clsIn_HoaDon(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "1410"
                Dim p_1410 As New K1410.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_1410.clsIn_HoaDon(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "2310"
                Dim p_2310 As New K2310.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2310.clsIn_HoaDon(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "2510"
                ...
                p_2510.clsIn_HoaDon(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "2610"
                Dim p_2610 As New K2610.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2610.clsIn_HoaDon(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "6410"
                Dim p_6410 As New K6410.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_6410.clsIn_HoaDon(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "2810"
                Dim p_2810 As New K2810.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2810.clsIn_HoaDon(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "4810"
                Dim p_4810 As New K4810.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_4810.clsIn_HoaDon(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
