Public Class frmImfor_HoaDonHangGiuHo
    ...
    Private Sub frmImfor_HoaDonHangGiuHo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Provider.Rows.Count > 0 Then
            ...
            p_Company = Provider.Rows(0).Item(0).ToString()
        ...
        Me.XtraForm1_Load()
        'hieptd4 add
        If Not Me.txtCompany.EditValue Is Nothing Then
            If Me.txtCompany.EditValue.ToString.Trim = "" Then
                Me.txtCompany.EditValue = p_Company
            End If
        Else
        End If
        'end hieptd4 add
    ...
    Private Sub InChungTuHoaDon_HangGiuHo(ByVal p_Form As Object, ByVal W_SoLenh As String, _
        ...
        Select Case g_Company_Code
            ...
            Case "4510" 'KV5
                Dim p_TichKeKV5 As New K4510.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_TichKeKV5.clsIn_HoaDon_HangGiuHo(p_Form, W_SoLenh, _
                                   DtTable, _
                                     DtTable1, _
                                     DtTable2,
                                     SubTable, _
            ...
            Case "1410"
                Dim p_1410 As New K1410.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_1410.clsIn_HoaDon_HangGiuHo(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "1910"
                Dim p_1910 As New K1910.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_1910.clsIn_HoaDon_HangGiuHo(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "2010"
                Dim p_2010 As New K2010.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2010.clsIn_HoaDon_HangGiuHo(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "2210"
                Dim p_2210 As New K2210.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2210.clsIn_HoaDon_HangGiuHo(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "2310"
                Dim p_2310 As New K2310.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2310.clsIn_HoaDon_HangGiuHo(p_Form, W_SoLenh, _
                                   DtTable, _
                                     DtTable1, _
                                     DtTable2,
                                     SubTable, _
            ...
            Case "2510"
                ...
                p_2510.clsIn_HoaDon_HangGiuHo(p_Form, W_SoLenh, _
                                 DtTable, _
                                   DtTable1, _
                                   DtTable2,
                                   SubTable, _
            ...
            Case "2610"
                ...
                p_2610.clsIn_HoaDon_HangGiuHo(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "6410"
                ...
                p_6410.clsIn_HoaDon_HangGiuHo(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "2810"
                Dim p_2810 As New K2810.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_2810.clsIn_HoaDon_HangGiuHo(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
            ...
            Case "4810"
                Dim p_4810 As New K4810.Class1(g_Config_XMLDatatable, _
                                                          ...
                                                          g_Company_DBName, g_UserName, g_LicenceHost, g_DBUser, _
                                                          g_DBPass, g_CompanyAPI)
                p_4810.clsIn_HoaDon_HangGiuHo(p_Form, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        ...
        Try
            ...
            InChungTuHoaDon_HangGiuHo(Me, W_SoLenh, _
                                  DtTable, _
                                    DtTable1, _
                                    DtTable2,
                                    SubTable, _
