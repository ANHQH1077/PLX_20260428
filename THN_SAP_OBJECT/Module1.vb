Module Module1
    ...
    Public p_KiemTraDiChuyen_TD As Boolean = False
    ...
    Public Function GetDataSet(ByVal p_SQL As String, ByVal p_Error As String) As DataSet
        ...
        Try
            p_DataSet = g_Services.Sys_SYS_GET_DATASet_Des(p_SQL, p_Error)
    ...
    Public Function mdlSyncDeliveries_CheckMaLenh(ByVal i_malenh As String, ByVal i_ngayxuat As String) As Boolean
        '-----------------------------------------------------------------
