Public Class frmImfor_HoaDon
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        ...
        Dim p_RptHoasDon As New KV2_HoaDonVCNB
        Dim p_RptHoasDon_Sub As New KV2_HoaDonVCNB_Sub
        ...
        Try
            ...
            If W_ChietKhau > 0 Then
                ...
                p_RptHoasDon1.Parameters.Item("P_DonViMua").Value = DtTable.Rows(0).Item("TenKhachHang").ToString
            ...
            Else
                Try
                    ...
                    p_RptHoasDon.Parameters.Item("P_DonViMua").Value = DtTable.Rows(0).Item("TenKhachHang").ToString
