...
Public Class SCADAR_HTTG_FOX
    ...
    Private Function GetStatusType() As String
        ...
        p_Datatatable = GetDataTable(p_SQL, p_SQL) ' g_Services.Sys_SYS_GET_DATATABLE_Des(p_SQL, p_SQL)
...
HoangHoaPhaChe:
    ...
    Private Function mdlQCI_GetVCFSub_NSE5(ByVal i_temp As String, _
        ...
        Try
            ...
            l_dt = GetDataTable(l_sql, l_sql) '  g_Services.Sys_SYS_GET_DATATABLE_Des(l_sql, l_sql)
