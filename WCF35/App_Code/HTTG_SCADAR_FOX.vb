...
Public Class HTTG_SCADAR_FOX
    ...
    Public Function mdlHTTG_To_Scadar(ByVal p_User_Name As String, ByVal p_TypeIn As String, ByVal p_SoLenh As String, ByVal g_LoaiVanChuyen As String, _
    ...
    Public Function GetConnectFox(ByRef p_DessErr As String, ByVal p_TypeIn As String, ByVal g_LoaiVanChuyen As String, Optional ByVal p_Terminal As String = "") As Boolean
        ...
        g_StrConnectFox = "Provider=VFPOLEDB.1;Data Source=" & p_Path & ";Collating Sequence=MACHINE;Exclusive = no;Advantage Server Type=ADS_REMOTE_SERVER"
