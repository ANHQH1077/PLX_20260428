...
Partial Class FrmChangeStatus
    ...
    Private Sub InitializeComponent()
        ...
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.ColSoLenh, Me.NgayXuat, Me.MaPhuongTien, Me.Status, Me.CHECKUPD})
        ...
        Me.GridView1.Where = "Status in  ('3','31','4','5')"
        '
        'ColSoLenh
        '
        ...
        Me.Status.ColumnEdit = Me.RepositoryItemGridLookUpEdit1
        ...
        Me.Status.SQLString = "select Status, Name from FPT_TrangThaiLenh_V where Status  in ('3','31','4','5')"
        ...
        Me.Text = "Thay đổi trạng thái lệnh xuất"
