...
Module HUYTICHKE
    ...
    '1
    Public Function Scadar_HuyTichKe(ByVal p_WareHouse As String, ByVal p_TypeIn As String, _
                                        ByVal p_SoLenh As String, ByVal g_LoaiVanChuyen As String, _
                                        Optional ByVal p_Terminal As String = "", Optional ByVal p_LyDo As String = "") As String
        Dim p_SQL As String
        ...
        Try
            ...
            If Not p_DataSet Is Nothing Then
                If p_DataSet.Tables.Count > 0 Then
                    ...
                    p_ArrRow = g_Table_Sys_Config.Select("KEYCODE='INTANK_E5'")
                    If p_ArrRow.Length > 0 Then
            ...
            If g_DBTYPE = "SQL" Then
                ...
                If g_KV1 = True Then
                    KV1modHuyTichKe(p_WareHouse, "out", p_SoLenh, g_LoaiVanChuyen, p_Eror, p_Desc, p_Terminal, p_LyDo)
                Else
    ...
    '1
    Public Function Scadar_HuyTichKeKiemtra(ByRef p_Eror As Boolean, ByVal p_WareHouse As String, ByVal p_TypeIn As String, ByVal p_SoLenh As String, _
                                                ByVal g_LoaiVanChuyen As String, Optional ByVal p_Terminal As String = "") As String
        Dim p_SQL As String
        Dim p_DataSet As DataSet
        'Dim p_Eror As Boolean
        Dim p_Desc As String
        ...
        Try
            ...
            'If UCase(g_TypeConnet) = "FOX" Then
            '    If GetConnectFox(p_Desc, p_TypeIn, g_LoaiVanChuyen, p_Terminal) = False Then
            '        Scadar_HuyTichKeKiemtra = p_Desc
            '        p_Eror = True
            '        Exit Function
            '    End If
            'End If
            ...
            If g_DBTYPE = "SQL" Then
                ...
                'Else
                modHuyTichKeKiemTra(p_WareHouse, p_TypeIn, p_SoLenh, g_LoaiVanChuyen, p_Eror, p_Desc, p_Terminal)
                'End If
        ...
        Catch ex As Exception
            Scadar_HuyTichKeKiemtra = "HTTG_To_Scadar: " & ex.Message
        End Try
    End Function
    ...
    Private Sub modHuyTichKe(ByVal p_WareHouse As String, ByVal p_TypeIn As String, ByVal p_SoLenh As String, ByVal g_LoaiVanChuyen As String, _
        ...
        If p_2Scadar = True Or p_2ScadarE5 = True Then
            ...
            'Kiem tra truong hop co PH va TD
...
Line_Intank:
            ...
            p_TableExec.Clear()
            p_TableTichKeHist = p_TableExec.Clone
            p_DataRow = p_TableTichKeHist.NewRow
            p_DataRow.Item(0) = "INSERT INTO tblTichke_Hist ([SoTichKe],[NgayXuat] ,[SoLenh],[MaNgan] ,[TableId],[NgayTichKe],[SoBienBan] , UpdUser,CrDate) " & _
                        " select [SoTichKe],[NgayXuat] ,[SoLenh],[MaNgan] ,[TableId],[NgayTichKe],[SoBienBan] , '" & g_UserName & "',getdate() from  tblTichke where SoLenh='" & p_SoLenh & "'"
            p_TableTichKeHist.Rows.Add(p_DataRow)
            ...
            If g_Services.Sys_Execute_DataTbl(p_TableTichKeHist, p_SQL) = False Then
                'MsgBox(p_SQL)
                'p_Desc = p_SQL
                ' p_Error = True
                '  Exit Sub
            ...
            Else
                ...
                Dim p_SAPOFF As Boolean = False
                p_SQL = "select KeyValue from sys_config  where upper(KeyCode) ='SAPOFF'  and isnull(KeyValue,'') ='Y'"
                ...
                Else
                    p_DataRow = p_TableExec.NewRow
                    p_SQL = "update tblLenhXuatE5 Set Status='1',UpdatedBy='" & g_UserName & "'  where SoLenh='" & p_SoLenh & "'"
                    p_DataRow.Item(0) = p_SQL
                    p_TableExec.Rows.Add(p_DataRow)
                End If
            End If
    ...
    '20180910
    'Ham kiem tra cac lenh ghep neu co 1 ngan cua bat ly lenh nao da bom hang thi khong cho huy lenh
    Private Sub modHuyTichKeKiemTra(ByVal p_WareHouse As String, ByVal p_TypeIn As String, ByVal p_SoLenh As String, ByVal g_LoaiVanChuyen As String, _
                             ByRef p_Error As Boolean, ByRef p_Desc As String, _
                              ByVal p_Terminal As String)
        Dim p_SQL As String
        Dim p_DataHTTG As DataTable
...
Line_Intank:
    ...
    Private Sub KV1modHuyTichKe(ByVal p_WareHouse As String, ByVal p_TypeIn As String, ByVal p_SoLenh As String, ByVal g_LoaiVanChuyen As String, _
                             ByRef p_Error As Boolean, ByRef p_Desc As String, _
                              ByVal p_Terminal As String, Optional ByVal p_Lydo As String = "")
        Dim p_SQL As String
        Dim p_DataHTTG As DataTable
        Dim p_CountRow As Integer
        'Dim p_CountCol As Integer
...
Line_Intank:
            ...
            Dim p_UpdateDate As String = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss")

            p_TableExec.Clear()
            p_DataRow = p_TableExec.NewRow            
            p_DataRow.Item(0) = "UPDATE tblLenhXuatE5 set GhiChu=N'lydohuy-" & p_Lydo & "', UpdatedBy='" & g_User_ID & "', UpdateDate='" & p_UpdateDate & "' where SoLenh='" & p_SoLenh & "'"
            p_TableExec.Rows.Add(p_DataRow)
            If g_Services.Sys_Execute_DataTbl(p_TableExec, p_SQL) = False Then
                'MsgBox(p_SQL)
                p_Desc = p_SQL
            ...
            p_TableExec.Clear()
            p_DataRow = p_TableExec.NewRow
            p_DataRow.Item(0) = "UPDATE tblLenhXuat_hanghoaE5 set UpdateDate='" & p_UpdateDate & "' where SoLenh='" & p_SoLenh & "'"
            p_TableExec.Rows.Add(p_DataRow)
            If g_Services.Sys_Execute_DataTbl(p_TableExec, p_SQL) = False Then
                'MsgBox(p_SQL)
                p_Desc = p_SQL
            ...
            If Left(p_SoLenh, Len(p_WareHouse)) = p_WareHouse Then
                ...
                'p_DataRow.Item(0) = "DELETE FROM  tblLenhXuatChiTietE5  where exists (select 1 from FPT_tblLenhXuat_HangHoaE5_V b " & _
                '                        " where (tblLenhXuatChiTietE5.TableID = b.TableID And tblLenhXuatChiTietE5.NgayXuat = b.NgayXuat) 	and b.SoLenh ='" & p_SoLenh & "')"
                p_DataRow.Item(0) = "delete from tblLenhXuatChiTietE5  where " & _
                              " exists (select 1 from FPT_tblLenhXuatChiTietE5_V a  where " & _
                                        " a.SoLenh='" & p_SoLenh & "'  and a.Row_id=tblLenhXuatChiTietE5.Row_id)"
                ...
                p_DataRow.Item(0) = " delete  tblLenhXuatChiTietE5  where " & _
                        " not exists (select MaLenh from tblLenhXuat_HangHoaE5 " & _
                        " where tblLenhXuat_HangHoaE5.NgayXuat =tblLenhXuatChiTietE5.NgayXuat and MaLenh =tblLenhXuatChiTietE5.MaLenh )"
...
Line_Intank:
    ...
    Public Function B12_UpdateScadar(ByVal p_WareHouse As String, ByVal p_TypeIn As String, ByVal p_SoLenh As String, ByVal g_LoaiVanChuyen As String, Optional ByVal p_Terminal As String = "") As String
        ...
        Catch ex As Exception
            B12_UpdateScadar = "HTTG_To_Scadar: " & ex.Message
        End Try
    End Function
                ...
                If p_Where_Check.ToString.Trim <> "" Then
                    If p_HangHoaE5 = True Then
                        ...
                        If Not p_DataTableCheckID Is Nothing Then
                            ...
                            p_StrExeE5 = "Update " & p_TableName_E5 & " set " & _
