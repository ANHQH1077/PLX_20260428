Public Class FrmLenhXuat_NoiDia
    Public g_LXLoai As String = "CIF"
    Public g_LXPhieu As String = "NOIDIA"
    ...
    Private Sub FrmTaoMoiLenhXuat_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If g_LXLoai = "CIF" Then
            p_Slog = "0002"
            ChuyenVanChuyen.Properties.ReadOnly = False
        End If
        ...
        p_SQL = "select   Vbeln as SoHopDong,  ZLSCH as PaymentMethod,ZTERM as Term, INCO2 as Inco2, Inco1 from dbo.tblProjects with (nolock) where  Vkorg  in ('" & g_Company_Code & "')  and " & _
           "convert(date,getdate()) >= convert(date, case when isdate(Guebg) =1 then convert(date,Guebg)  else getdate() end ) " & _
           "and convert(date,getdate()) <= convert(date, case when isdate(Gueen) =1 then convert(date,Gueen)  else getdate() end) " & _
            "and Kunnr = :MaKhachHang and Vtweg = :MaPhuongThucBan"
        ...
        p_SQL = "SELECT MaNguon, TenNguon FROM tblNguon  where manguon  ='N30' and Status='X'"
        Me.MaNguon.SqlString = p_SQL


        p_SQL = "SELECT [Code] ,[GrpName] FROM .[tblTankGroupList_V]"
        'Dim p_Tale As DataTable
        If g_NhomBeXuat = False Then
            p_SQL = p_SQL & "  WHERE  Code = 'TD'"
            Me.NhomBeXuat.Properties.ReadOnly = True
        End If

        Me.NhomBeXuat.SQL_String = p_SQL
        ...
        If g_SoLenh_Q = "" Then
            ...
            If g_LXLoai = "CIF" Then
                p_Slog = "0002"
                ChuyenVanChuyen.Properties.ReadOnly = False
                Me.ChuyenVanChuyen.EditValue = Me.ChuyenVanChuyen.CheckValue
            ...
            If g_NhomBeXuat = False Then
                Me.NhomBeXuat.EditValue = "TD"
            Else
                Me.NhomBeXuat.EditValue = ""
            End If
        ...
        If UCase(e.Column.FieldName) = UCase("MaHangHoa") Or UCase(e.Column.FieldName) = UCase("DonViTinh") Or UCase(e.Column.FieldName) = UCase("PhiVT") Or UCase(e.Column.FieldName) = UCase("TheBVMT") Or UCase(e.Column.FieldName) = UCase("GiaCty") Then
            If Not e.Value Is Nothing Then
                ...
                If Not Me.PrcingDate.EditValue Is Nothing Then
                    p_NgayXuat = Me.PrcingDate.EditValue.ToString.Trim()
                End If
        ...
        If Not Me.SoLenh.EditValue Is Nothing Then
            If Me.SoLenh.EditValue.ToString.Trim <> "" Then
                ...
                Else
                    ...
                    'anhqh  2020 bo sung them tim kiem lenh dong bo tu SAP
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        ...
        If Me.FormStatus = True Then
            ...
            If Not Me.Tax.EditValue Is Nothing Then
                Integer.TryParse(Me.Tax.EditValue.ToString.Trim, p_Tax)
            End If
            If p_Tax = 0 Then
                Me.Tax.EditValue = 10
            End If
    ...
    Private Sub NgayXuat_EditValueChanging(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ChangingEventArgs) Handles PrcingDate.EditValueChanging

    End Sub

    Private Sub NgayXuat_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles PrcingDate.Validated
    ...
    Private Sub ResetPrice()
        ...
        Dim p_Count As Integer
        Dim p_PTBan, p_MaKH, p_MaHH, p_DVT, p_Term, p_LoaiTien, p_MaTuyenDuong, p_LHVT, p_Group, p_SoHopDong As String
        Dim p_NgayXuat As String
        'Dim p_Object() As 
        Dim p_CurrentDate As Date
        ...
        If Not PrcingDate.EditValue Is Nothing Then
            p_NgayXuat = CDate(PrcingDate.EditValue).ToString("yyyyMMdd HH:mm:ss")
        End If
        ...
        If p_NgayXuat = "" Then
            p_GetCurrentDate(p_CurrentDate)
            p_NgayXuat = CDate(p_CurrentDate).ToString("yyyyMMdd HH:mm:ss")
        End If
    ...
    Private Sub U_DateEdit1_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NgayHopDong.EditValueChanged

    End Sub

  

    Private Sub txtPhuongThucXuat_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtPhuongThucXuat.EditValueChanged
