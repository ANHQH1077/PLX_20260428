Public Class FrmCopyNew
    ...
    Private Sub Requery(ByVal p_SoLenhTK As String)
    ...
    Private Sub SaoChepLenhXuat()
        ...
        Dim p_Count As Integer
        Dim p_DO1_SoLenh As String = ""
        Dim p_DO1_MaLenh As String = ""
        Dim p_DO1 As Integer = 0
        Dim p_CountDO1 As Integer
        If Not Me.SoLenhGoc.EditValue Is Nothing Then
            p_SoLenh = Me.SoLenhGoc.EditValue.ToString.Trim
        End If
        ...
        p_SQL = "select DO1_SoLenh from tblLenhxuate5  with (nolock) where solenh ='" & p_SoLenh & "'"
        p_Table = GetDataTable(p_SQL, p_SQL)
        If Not p_Table Is Nothing Then
            If p_Table.Rows.Count > 0 Then
        ...
        For p_Count = 1 To p_SoLuong
            ...
            If p_DO1 > 0 Then
                p_DO1_SoLenh = LaySoLenhMoi()
                'p_DO1_MaLenh = FPT_GetMaLenh(p_DO1_SoLenh)
                'If p_MaLenh = "0000" Then
                '    'ShowMessageBox(True, "Mã lệnh đã có trong hệ thống", 3)
                '    p_DO1_MaLenh = ""
                'End If
            ...
            'If p_DO1_MaLenh = "" Then
            '    p_DO1_SoLenh = ""
            'End If

            p_SQL = "exec  SaoChepLenhXuat  '" & p_SoLenh & "','" & p_MaLenh & "','" & g_UserName & _
                            "','" & p_SoLenhNew & "','" & p_LenhXuatLoai & "','" & p_LenhXuatPhieu & "',0, '" & p_DO1_SoLenh & "','" & p_DO1_MaLenh & "'"
    ...
    Function GetTableID(ByVal p_HangHoa As String, ByVal p_MaVanChuyen As String, ByVal p_FunctionTableId As String) As String
        Dim p_SQL As String
        Dim p_DataTable As DataTable
        ' Dim p_FunctionTableId As String = ""
        Dim p_date As Date
