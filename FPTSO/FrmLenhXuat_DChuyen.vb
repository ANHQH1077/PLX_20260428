Public Class FrmLenhXuat_DChuyen
    Public g_LXLoai As String = ""
    Public g_LXPhieu As String = "DICHUYEN"
    ...
    Private Sub FrmTaoMoiLenhXuat_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        p_SQL = ""
        If g_LXLoai = "" Then
            ' Me.Text = Me.Text & " - không TD"ss
            p_SQL = "SELECT [EBELN] as STO ,[BSART] as POType,[WERKS] as KhoNhap  FROM [tblSTO] where convert(date,isnull( Bedat, getdate() -5 )) " & _
                    "<= convert(date,  :NgayXuat)  and convert(date,isnull( eindt, getdate()  + 5 )) >= convert(date, :NgayXuat) " & _
                    " and [BSART] in ('P223', 'P251') "
        Else

            p_SQL = "SELECT [EBELN] as STO ,[BSART] as POType,[WERKS] as KhoNhap  FROM [tblSTO] where convert(date,isnull( Bedat, getdate() -5 )) " & _
                 "<= convert(date,  :NgayXuat)  and convert(date,isnull( eindt, getdate()  + 5 )) >= convert(date, :NgayXuat) " & _
                 " and [BSART] in ('P222', 'P250') "
        End If
        Me.STO.SqlString = p_SQL
        ...
        If g_LXLoai = "" Then
            Me.Text = Me.Text & " - không TD"
        Else
            Me.Text = Me.Text & " - có TD"
        End If
                    ...
                    If Not p_DataTable Is Nothing Then
                        ...
                        Else
                            ...
                            If g_LXLoai = "TD" Then
                                ...
                                Me.NgayXuat.EditValue = p_DateCreate
                                Me.LoaiPhieu.Enabled = True
                                Me.LoaiPhieu.Properties.ReadOnly = False
                            Else
                                Me.ChuyenVanChuyen.EditValue = Me.ChuyenVanChuyen.UnCheckValue
                                Me.LoaiPhieu.EditValue = "V144"
                                Me.NgayXuat.EditValue = p_DateCreate
    ...
    Private Sub FrmLenhXuat_DChuyen_MenuComplete(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.MenuComplete
    ...
    Private Sub ToolStripButton4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton4.Click
        ...
        If Not Me.KhoNhap.EditValue Is Nothing Then
            p_KHoXuat = Me.KhoNhap.EditValue.ToString.Trim
        End If
        ...
        If Not Me.MaPhuongThucBan.EditValue Is Nothing Then
            p_PTBan = Me.MaPhuongThucBan.EditValue.ToString.Trim
        End If
        Dim FrmDO1 As New FrmLenhXuat_NoiDiaDO1
    ...
    Private Sub POType_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles POType.EditValueChanged
        Dim p_Value As String
        Dim p_SQL As String
        Dim p_Table As DataTable
        Dim p_MaPTBan As String = ""
        Dim p_Required As Boolean = False

        If Not Me.MaPhuongThucBan.EditValue Is Nothing Then
            p_MaPTBan = Me.MaPhuongThucBan.EditValue.ToString
        End If
        If Not Me.POType.EditValue Is Nothing And p_MaPTBan <> "03" Then
            p_Value = Me.POType.EditValue.ToString.Trim
            p_SQL = "select UPPER (VTWEG_CHK) as VTWEG_CHK from [tblSO_PO_Type]  where Code ='" & p_Value & "'"
            p_Table = GetDataTable(p_SQL, p_SQL)
            If Not p_Table Is Nothing Then
                If p_Table.Rows.Count > 0 Then
                    If p_Table.Rows(0).Item(0).ToString.Trim = "X" Or p_Table.Rows(0).Item(0).ToString.Trim = "Y" Then
                        p_Required = True
                    End If
                End If
            End If
