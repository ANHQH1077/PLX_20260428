Module SAP_HTTG
    ...
    Public Function mdlSyncDeliveries_SynSpecific(ByVal p_User_ID As Integer, ByVal p_Company_Code As String, ByVal i_solenh As String, ByRef o_err As String) As Boolean
