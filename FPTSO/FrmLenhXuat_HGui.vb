Public Class FrmLenhXuat_HGui
    Public g_LXLoai As String = ""
    Public g_LXPhieu As String = "HANGGUI"
    ...
    Private Sub FrmTaoMoiLenhXuat_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        p_SQL = "SELECT MaNguon, TenNguon FROM tblNguon  where manguon in ('N40','N45') and Status='X'"
