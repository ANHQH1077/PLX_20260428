...
#End Region
    ...
    Private Sub p_QuerySource(ByVal p_LoadForm As Boolean)
        ...
        Dim p_AutoWidth As Boolean = True
        ...
        Try
            ...
            If p_OrderbyExt <> "" Then
                p_SQLString = p_SQLString & " order by  " & p_OrderbyExt
            End If
                    ...
                    If Me.GridView1.Columns.Item(p_Count).Visible = True Then
                        ...
                        If p_where = "" Then
                            p_where = " upper( [" & Me.GridView1.Columns.Item(p_Count).FieldName & "]) Like N'%" & _
                                    UCase(Replace(Me.U_TextBox1.EditValue.ToString.Trim, "*", "%", 1)) & "%'"
                        Else
    ...
    Sub p_Search()
        ...
        '    MsgBox("Giá trị tìm kiếm không được trống")
        'End If
        If Me.U_TextBox1.EditValue Is Nothing Then
            Me.U_TextBox1.EditValue = "*"
        End If
        Me.Cursor = Cursors.WaitCursor
        p_QuerySource(False)
        Me.Cursor = Cursors.Default
