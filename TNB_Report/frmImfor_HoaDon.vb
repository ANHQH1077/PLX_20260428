Public Class frmImfor_HoaDon
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        ...
        Try
            ...
            ' 01/02/2013 QueHV Cau Hinh Tuy Chon Kho Giay
            If W_ChietKhau > 0 Then
                Dim rpt As New rptHoaDon1
                ...
                rpt.SetParameterValue("P_Nam", Date.Now.Year)
                ...
                rpt.SetParameterValue("P_NguoiMua", txtNguoiMuaHang.Text)
                ...
                rpt.SetParameterValue("P_MaSoThue_MH", DtTable.Rows(0).Item("MaSoThue").ToString)
                rpt.SetParameterValue("P_TongCong", Format(Convert.ToInt64(TongTien - W_ChietKhau), "n0").Replace(",", "."))

                ' 01/02/2013 QueHV Sua cach tinh thue GTGT theo cach tinh ma nghiep vu cung cap
                rpt.SetParameterValue("P_ThueGTGT", txtThueGTGT.Text.Trim)
                rpt.SetParameterValue("P_TienThueGTGT", Format(CInt(W_ThueGTGT), "n0").Replace(",", "."))
                ...
                rpt.SetParameterValue("P_TongThanhToan", Format(TongThanhToan, "n0").Replace(",", "."))

                rpt.SetParameterValue("P_TongBangChu", mdlFunction.Number2Text(CLng(TongThanhToan)) + " đồng chẵn")
                rpt.SetParameterValue("P_SoPhuongTien", DtTable.Rows(0).Item("MaPhuongTien").ToString)
                rpt.SetParameterValue("P_MaKhachHang", DtTable.Rows(0).Item("MaKhachHang").ToString)
                ...
                rpt.SetParameterValue("P_SoNiem", DtTable.Rows(0).Item("Niem").ToString)
                ...
                rpt.SetParameterValue("P_KhoangCachTamMuc", srt_hhh)
                rpt.SetParameterValue("P_PhuongThucTT", txtPhuongThuc.Text.Trim)
                rpt.SetParameterValue("P_DonViCungCapVanTai", txtDonViCCVanTai.Text)
                rpt.SetParameterValue("P_ChietKhauThuongMai", Format(W_ChietKhau, "n0").Replace(",", "."))
            ...
            Else
                ...
                rpt.SetParameterValue("P_MaSoThue_MH", DtTable.Rows(0).Item("MaSoThue").ToString)
                rpt.SetParameterValue("P_TongCong", Format(Convert.ToInt64(TongTien), "n0").Replace(",", "."))
    ...
    Private Sub Update_TTHoaDon()
        ...
        Try
            ...
            For index As Integer = 0 To Me.GridView1.RowCount - 1
                ...
                End If
            Next
            p_SQL = " exec KhachHangUpdateAddress '" & Provider.Tables(0).Rows(0).Item(3).ToString.Trim & "','" & txtDiChiDonViMuaHang.Text & "'"
            If SQL_Execute(p_SQL, p_SQL) = False Then
                ShowMessageBox("", p_SQL)
                Exit Sub
            End If
