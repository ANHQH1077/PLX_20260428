...
Module Module4
    ...
    Private Sub OnElapsedTimeHopDong()
        Try
            'p_GetSOPutAPI_Company()
    ...
    Private Sub OnElapsedTimeDonGia()
        Try
            'p_GetSOPutAPI_Company()
    ...
    Private Sub OnElapsedTonKhoToKhai()
        Try
            'p_GetSOPutAPI_Company()
    ...
    Private Sub OnElapsedTuyenDuong()
        Try
            'p_GetSOPutAPI_Company()
    ...
    Private Sub OnElapsedTimeNhaCungCap()
        Try
            ExecRuntimeNhaCungCap()
